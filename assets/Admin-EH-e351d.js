import{j as e,s as N,D as $,R as ie,C as ae,S as qe,e as Ie,h as Le,i as Pe,b as O,k as $e}from"./index-DwWWv2XG.js";import{r as u,N as W,L as Fe,d as Ae,b as Te,R as De,c as R}from"./vendor-react-Be-nUyB0.js";import{R as ze,s as Be,c as Y,g as de}from"./authService-CIxnxZhs.js";import{I as re}from"./Icon-B-ryQXGI.js";import"./vendor-supabase-J7ITh-P0.js";const me={estado_emocional:["#1A3358","#10243E"],estres_academico:["#D26B53","#B5403E"],sueno_descanso:["#B7A8D9","#6E5BA0"],apoyo_social:["#8FB8A0","#4FA88E"],motivacion_pertenencia:["#E5C868","#B08F1F"]},ue=["#1A3358","#10243E"],le=720,oe=460,J=le/2,K=oe/2,Q=160,xe=600,Oe=18e-5;function Ue(s,a){const l=parseInt(s.slice(1),16),n=Math.min(255,(l>>16&255)+Math.round(2.55*a)),t=Math.min(255,(l>>8&255)+Math.round(2.55*a)),i=Math.min(255,(l&255)+Math.round(2.55*a));return`#${(n<<16|t<<8|i).toString(16).padStart(6,"0")}`}function We({data:s=[]}){const a=u.useRef(null),l=u.useRef({rotY:0,rotX:.25}),[n,t]=u.useState(0),[i,o]=u.useState(null),r=u.useMemo(()=>{const b=s.length||1;return s.map((k,C)=>{const E=Math.acos(1-2*(C+.5)/b),L=Math.PI*(1+Math.sqrt(5))*C;return{...k,p:{x:Math.sin(E)*Math.cos(L),y:Math.sin(E)*Math.sin(L),z:Math.cos(E)}}})},[s]),d=Math.max(1,...s.map(b=>b.mentions||0)),h=Math.min(...s.map(b=>b.mentions||0)),v=b=>d===h?38:30+(b-h)/(d-h)*28;u.useEffect(()=>{let b,k=performance.now();const C=E=>{const L=E-k;k=E,i||(l.current.rotY+=L*Oe),t(B=>B+1),b=requestAnimationFrame(C)};return b=requestAnimationFrame(C),()=>cancelAnimationFrame(b)},[i]);function x(b){var E,L;b.preventDefault();const{rotX:k,rotY:C}=l.current;o({startX:b.clientX,startY:b.clientY,startRotX:k,startRotY:C}),(L=(E=b.currentTarget).setPointerCapture)==null||L.call(E,b.pointerId)}function f(b){if(!i)return;const k=b.clientX-i.startX,C=b.clientY-i.startY;l.current.rotY=i.startRotY+k*.006,l.current.rotX=Xe(i.startRotX+C*.005,-1.2,1.2)}function m(b){var k,C;(C=(k=b.currentTarget).releasePointerCapture)==null||C.call(k,b.pointerId),o(null)}const{rotX:c,rotY:p}=l.current,_=Math.cos(p),y=Math.sin(p),w=Math.cos(c),g=Math.sin(c),j=r.map(b=>{const{x:k,y:C,z:E}=b.p,L=k*_+E*y,B=-k*y+E*_,S=C,M=S*w-B*g,A=S*g+B*w,I=L,F=A*Q,P=xe/(xe-F);return{...b,sx:J+I*Q*P,sy:K+M*Q*P,depth:A,scale:P}});return j.sort((b,k)=>b.depth-k.depth),s.length?e.jsxs("div",{className:"bubbles-wrap",children:[e.jsxs("svg",{ref:a,viewBox:`0 0 ${le} ${oe}`,className:`bubbles-svg ${i?"dragging":""}`,role:"img","aria-label":"Modelo dimensional 3D del bienestar",onPointerDown:x,onPointerMove:f,onPointerUp:m,onPointerCancel:m,style:{cursor:i?"grabbing":"grab",touchAction:"none"},children:[e.jsxs("defs",{children:[j.map(b=>{const[k,C]=me[b.dimension_id]||ue;return e.jsxs("radialGradient",{id:`grad-${b.dimension_id}`,cx:"32%",cy:"28%",r:"75%",children:[e.jsx("stop",{offset:"0%",stopColor:Ue(k,35)}),e.jsx("stop",{offset:"55%",stopColor:k}),e.jsx("stop",{offset:"100%",stopColor:C})]},`grad-${b.dimension_id}`)}),e.jsx("filter",{id:"bubble-shadow",x:"-30%",y:"-30%",width:"160%",height:"160%",children:e.jsx("feDropShadow",{dx:"0",dy:"8",stdDeviation:"14",floodColor:"#10243E",floodOpacity:"0.30"})}),e.jsxs("radialGradient",{id:"aura",cx:"50%",cy:"50%",r:"50%",children:[e.jsx("stop",{offset:"0%",stopColor:"#C9A227",stopOpacity:"0.18"}),e.jsx("stop",{offset:"60%",stopColor:"#C9A227",stopOpacity:"0.05"}),e.jsx("stop",{offset:"100%",stopColor:"#C9A227",stopOpacity:"0"})]})]}),e.jsx("circle",{cx:J,cy:K,r:Q+60,fill:"url(#aura)"}),e.jsx("circle",{cx:J,cy:K,r:"10",fill:"#C9A227",opacity:"0.85"}),e.jsx("text",{x:J,y:K+26,textAnchor:"middle",fontSize:"11",fill:"#10243E",fontWeight:"700",style:{userSelect:"none",pointerEvents:"none"},children:"AURA"}),j.map(b=>{const k=v(b.mentions||0)*b.scale,C=.55+(b.depth+1)*.225;return e.jsxs("g",{transform:`translate(${b.sx}, ${b.sy})`,style:{opacity:C},children:[e.jsx("circle",{r:k,fill:`url(#grad-${b.dimension_id})`,filter:"url(#bubble-shadow)"}),e.jsx("ellipse",{cx:-k*.32,cy:-k*.42,rx:k*.34,ry:k*.18,fill:"white",opacity:"0.35"}),b.depth>-.1&&e.jsxs(e.Fragment,{children:[e.jsx("text",{y:k+16,textAnchor:"middle",fontSize:"11",fontWeight:"700",fill:"#10243E",style:{userSelect:"none",pointerEvents:"none"},children:b.dimension_label||b.dimension_id}),e.jsxs("text",{y:k+28,textAnchor:"middle",fontSize:"9",fill:"#6B7280",style:{userSelect:"none",pointerEvents:"none"},children:[b.mentions," ",b.mentions===1?"mención":"menciones"]})]})]},b.dimension_id)}),e.jsx("text",{x:le-12,y:oe-12,textAnchor:"end",fontSize:"10",fill:"#9CA3AF",style:{userSelect:"none",pointerEvents:"none"},children:i?"Soltando para volver a animación":"Arrastra para rotar ↻"})]}),e.jsx("div",{className:"bubbles-legend",children:s.map(b=>{const[k]=me[b.dimension_id]||ue;return e.jsxs("div",{className:"legend-item",children:[e.jsx("span",{className:"legend-dot",style:{background:k}}),e.jsxs("div",{children:[e.jsx("strong",{children:b.dimension_label}),e.jsxs("small",{children:[b.mentions," ",b.mentions===1?"mención":"menciones"," · ","Promedio: ",b.avg_score]})]})]},b.dimension_id)})}),e.jsx("style",{children:`
      ...
      `})]})}const Ze=[{id:"bajo",label:"Bajo (mantener)"},{id:"moderado",label:"Moderado (ajustar)"},{id:"prioritario",label:"Prioritario (acompañar)"}],ea=[{id:"autocuidado",label:"Autocuidado individual"},{id:"comunidad",label:"Comunidad / grupal"},{id:"ejercicio",label:"Ejercicio físico"},{id:"mindfulness",label:"Mindfulness / respiración"},{id:"arte",label:"Arte y expresión"},{id:"orientacion",label:"Orientación profesional"}];function aa({onUse:s}){const[a,l]=u.useState(!1),[n,t]=u.useState($[0].id),[i,o]=u.useState("moderado"),[r,d]=u.useState("autocuidado"),[h,v]=u.useState(3),[x,f]=u.useState(!1),[m,c]=u.useState([]),[p,_]=u.useState(null);async function y(){f(!0),_(null),c([]);try{const{data:g,error:j}=await N.functions.invoke("suggest-recommendations",{body:{dimension:n,level:i,type:r,count:h}});if(j)throw j;if(g!=null&&g.error)throw new Error(g.error);c((g==null?void 0:g.suggestions)||[])}catch(g){_((g==null?void 0:g.message)||"No pudimos generar sugerencias.")}finally{f(!1)}}function w(g){s==null||s({...g,dimension:n,level:i}),l(!1)}return e.jsxs(e.Fragment,{children:[e.jsx("button",{className:"btn btn-gold btn-sm",onClick:()=>l(!0),children:"✨ Sugerir con Pum-AI"}),a&&e.jsx("div",{className:"pumai-overlay",onClick:()=>l(!1),children:e.jsxs("div",{className:"pumai-modal",onClick:g=>g.stopPropagation(),children:[e.jsxs("header",{children:[e.jsx("h3",{children:"✨ Pum-AI · Sugerir recomendaciones"}),e.jsx("button",{className:"close",onClick:()=>l(!1),children:"✕"})]}),e.jsxs("div",{className:"form-grid",children:[e.jsxs("div",{className:"field",children:[e.jsx("label",{children:"Dimensión"}),e.jsx("select",{value:n,onChange:g=>t(g.target.value),children:$.map(g=>e.jsx("option",{value:g.id,children:g.label},g.id))})]}),e.jsxs("div",{className:"field",children:[e.jsx("label",{children:"Nivel de atención"}),e.jsx("select",{value:i,onChange:g=>o(g.target.value),children:Ze.map(g=>e.jsx("option",{value:g.id,children:g.label},g.id))})]}),e.jsxs("div",{className:"field",children:[e.jsx("label",{children:"Tipo de acción"}),e.jsx("select",{value:r,onChange:g=>d(g.target.value),children:ea.map(g=>e.jsx("option",{value:g.id,children:g.label},g.id))})]}),e.jsxs("div",{className:"field",children:[e.jsx("label",{children:"Cantidad"}),e.jsx("input",{type:"number",min:"1",max:"6",value:h,onChange:g=>v(Number(g.target.value))})]})]}),e.jsx("button",{className:"btn btn-primary",onClick:y,disabled:x,children:x?"Generando con Pum-AI…":"✨ Generar sugerencias"}),p&&e.jsx("p",{className:"error",children:p}),m.length>0&&e.jsxs("div",{className:"results",children:[e.jsxs("h4",{children:["Sugerencias (",m.length,")"]}),m.map((g,j)=>e.jsxs("article",{className:"suggestion",children:[e.jsx("strong",{children:g.title}),e.jsx("p",{children:g.description}),e.jsx("button",{className:"btn btn-coral btn-sm",onClick:()=>w(g),children:"＋ Usar esta"})]},j)),e.jsx("p",{className:"note text-center mt-2",children:"Revisa cada sugerencia antes de guardarla."})]})]})}),e.jsx("style",{children:`
        .pumai-overlay {
          position: fixed; inset: 0;
          background: rgba(10, 25, 41, 0.6);
          backdrop-filter: blur(4px);
      ...
      `})]})}function na({ctx:s}){const[a,l]=u.useState([]),[n,t]=u.useState(null),[i,o]=u.useState({}),[r,d]=u.useState(!0),[h,v]=u.useState({key:"sort_order",dir:"asc"});async function x(){d(!0);const{data:j}=await N.from("questions").select("*");l(j||[]),d(!1)}u.useEffect(()=>{x()},[]);function f(j){v(b=>b.key===j?{key:j,dir:b.dir==="asc"?"desc":"asc"}:{key:j,dir:"asc"})}const m=[...a].sort((j,b)=>{const k=j[h.key],C=b[h.key];if(k===C)return 0;if(k==null)return 1;if(C==null)return-1;const E=typeof k=="number"?k-C:String(k).localeCompare(String(C));return h.dir==="asc"?E:-E});function c(){const j=a.length?Math.max(...a.map(b=>b.sort_order))+1:1;t("new"),o({sort_order:j,dimension:$[0].id,question_text:"",is_reverse_scored:!1,active:!0})}function p(j){const b=a.length?Math.max(...a.map(k=>k.sort_order))+1:1;t("new"),o({sort_order:b,dimension:j.dimension||$[0].id,question_text:j.question_text,is_reverse_scored:!!j.is_reverse_scored,active:!0})}function _(j){t(j.id),o({...j})}async function y(){var j;if((j=i.question_text)!=null&&j.trim()){if(n==="new"){const{data:b,error:k}=await N.from("questions").insert(i).select().single();k||await z({ctx:s,action:"create",entity:"questions",entity_id:b.id,after_data:b})}else{const b=a.find(C=>C.id===n),{error:k}=await N.from("questions").update(i).eq("id",n);k||await z({ctx:s,action:"update",entity:"questions",entity_id:n,before_data:b,after_data:i})}t(null),o({}),x()}}async function w(j){const{error:b}=await N.from("questions").update({active:!j.active}).eq("id",j.id);b||await z({ctx:s,action:"toggle",entity:"questions",entity_id:j.id,before_data:{active:j.active},after_data:{active:!j.active}}),x()}async function g(j){if(!confirm(`¿Eliminar pregunta #${j.sort_order}?

"${j.question_text}"`))return;const{error:b}=await N.from("questions").delete().eq("id",j.id);b||await z({ctx:s,action:"delete",entity:"questions",entity_id:j.id,before_data:j}),x()}return r?e.jsx("div",{className:"spinner",style:{margin:"40px auto"}}):e.jsxs("div",{className:"panel",children:[e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",gap:8,flexWrap:"wrap"},children:[e.jsxs("h2",{children:["Banco de preguntas (",a.length,")"]}),e.jsxs("div",{style:{display:"flex",gap:8},children:[e.jsx(Qe,{onUse:p}),n!=="new"&&e.jsx("button",{className:"btn btn-primary btn-sm",onClick:c,children:"＋ Nueva"})]})]}),n==="new"&&e.jsx(ve,{draft:i,setDraft:o,onSave:y,onCancel:()=>{t(null),o({})}}),e.jsx("div",{className:"table-wrap mt-3",style:{overflowX:"auto"},children:e.jsxs("table",{className:"editor-table",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{style:{width:48},children:e.jsx(G,{k:"sort_order",sortBy:h,onSort:f,children:"#"})}),e.jsx("th",{children:e.jsx(G,{k:"question_text",sortBy:h,onSort:f,children:"Texto"})}),e.jsx("th",{style:{width:160},children:e.jsx(G,{k:"dimension",sortBy:h,onSort:f,children:"Dimensión"})}),e.jsx("th",{style:{width:80},children:e.jsx(G,{k:"is_reverse_scored",sortBy:h,onSort:f,children:"Inversa"})}),e.jsx("th",{style:{width:80},children:e.jsx(G,{k:"active",sortBy:h,onSort:f,children:"Activa"})}),e.jsx("th",{style:{width:140}})]})}),e.jsx("tbody",{children:m.map(j=>{var b;return n===j.id?e.jsx(ve,{draft:i,setDraft:o,onSave:y,onCancel:()=>{t(null),o({})}},j.id):e.jsxs("tr",{children:[e.jsx("td",{children:j.sort_order}),e.jsx("td",{children:j.question_text}),e.jsx("td",{children:((b=$.find(k=>k.id===j.dimension))==null?void 0:b.label)||j.dimension}),e.jsx("td",{children:j.is_reverse_scored?"✔":"—"}),e.jsx("td",{children:j.active?"✅":"⏸"}),e.jsxs("td",{className:"actions-cell",children:[e.jsx("button",{className:"icon-btn",onClick:()=>_(j),children:"✎"}),e.jsx("button",{className:"icon-btn",onClick:()=>w(j),children:j.active?"⏸":"▶"}),e.jsx("button",{className:"icon-btn danger",onClick:()=>g(j),children:"🗑"})]})]},j.id)})})]})})]})}function ve({draft:s,setDraft:a,onSave:l,onCancel:n}){return e.jsxs("tr",{style:{background:"var(--c-azul-100)"},children:[e.jsx("td",{children:e.jsx("input",{type:"number",min:"1",value:s.sort_order||1,onChange:t=>a({...s,sort_order:Number(t.target.value)})})}),e.jsx("td",{children:e.jsx("textarea",{value:s.question_text||"",onChange:t=>a({...s,question_text:t.target.value}),placeholder:"¿Pregunta?"})}),e.jsx("td",{children:e.jsx("select",{value:s.dimension,onChange:t=>a({...s,dimension:t.target.value}),children:$.map(t=>e.jsx("option",{value:t.id,children:t.label},t.id))})}),e.jsx("td",{children:e.jsx("input",{type:"checkbox",checked:!!s.is_reverse_scored,onChange:t=>a({...s,is_reverse_scored:t.target.checked})})}),e.jsx("td",{children:e.jsx("input",{type:"checkbox",checked:!!s.active,onChange:t=>a({...s,active:t.target.checked})})}),e.jsxs("td",{className:"actions-cell",children:[e.jsx("button",{className:"icon-btn primary",onClick:l,children:"✓"}),e.jsx("button",{className:"icon-btn",onClick:n,children:"✕"})]})]})}function ia({ctx:s}){const[a,l]=u.useState([]),[n,t]=u.useState(!0),[i,o]=u.useState(null),[r,d]=u.useState({});async function h(){t(!0);const{data:p}=await N.from("recommendations").select("*").order("dimension").order("level");l(p||[]),t(!1)}u.useEffect(()=>{h()},[]);function v(){o("new"),d({dimension:$[0].id,level:"bajo",title:"",description:"",active:!0})}function x(p){o(p.id),d({...p})}function f(p){o("new"),d({dimension:p.dimension||$[0].id,level:p.level||"moderado",title:p.title,description:p.description,active:!0})}async function m(){var p;if((p=r.title)!=null&&p.trim()){if(i==="new"){const{data:_}=await N.from("recommendations").insert(r).select().single();_&&await z({ctx:s,action:"create",entity:"recommendations",entity_id:_.id,after_data:_})}else{const _=a.find(w=>w.id===i),{error:y}=await N.from("recommendations").update(r).eq("id",i);y||await z({ctx:s,action:"update",entity:"recommendations",entity_id:i,before_data:_,after_data:r})}o(null),d({}),h()}}async function c(p){if(!confirm(`¿Eliminar recomendación "${p.title}"?`))return;const{error:_}=await N.from("recommendations").delete().eq("id",p.id);_||await z({ctx:s,action:"delete",entity:"recommendations",entity_id:p.id,before_data:p}),h()}return n?e.jsx("div",{className:"spinner",style:{margin:"40px auto"}}):e.jsxs("div",{className:"panel",children:[e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",gap:8,flexWrap:"wrap"},children:[e.jsxs("h2",{children:["Catálogo de recomendaciones (",a.length,")"]}),e.jsxs("div",{style:{display:"flex",gap:8},children:[e.jsx(aa,{onUse:f}),i!=="new"&&e.jsx("button",{className:"btn btn-primary btn-sm",onClick:v,children:"＋ Nueva"})]})]}),i==="new"&&e.jsx(be,{draft:r,setDraft:d,onSave:m,onCancel:()=>{o(null),d({})}}),e.jsx("div",{className:"table-wrap mt-3",style:{overflowX:"auto"},children:e.jsxs("table",{className:"editor-table",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{style:{width:160},children:"Dimensión"}),e.jsx("th",{style:{width:120},children:"Nivel"}),e.jsx("th",{children:"Título"}),e.jsx("th",{children:"Descripción"}),e.jsx("th",{style:{width:80},children:"Activa"}),e.jsx("th",{style:{width:120}})]})}),e.jsx("tbody",{children:a.map(p=>{var _;return i===p.id?e.jsx(be,{draft:r,setDraft:d,onSave:m,onCancel:()=>{o(null),d({})}},p.id):e.jsxs("tr",{children:[e.jsx("td",{children:((_=$.find(y=>y.id===p.dimension))==null?void 0:_.label)||p.dimension}),e.jsx("td",{children:e.jsx("span",{className:`lvl-bg-${p.level}`,style:{padding:"3px 8px",borderRadius:6,fontSize:"0.78rem",fontWeight:700},children:p.level})}),e.jsx("td",{children:p.title}),e.jsx("td",{children:e.jsx("small",{className:"note",children:p.description})}),e.jsx("td",{children:p.active?"✅":"⏸"}),e.jsxs("td",{className:"actions-cell",children:[e.jsx("button",{className:"icon-btn",onClick:()=>x(p),children:"✎"}),e.jsx("button",{className:"icon-btn danger",onClick:()=>c(p),children:"🗑"})]})]},p.id)})})]})})]})}function be({draft:s,setDraft:a,onSave:l,onCancel:n}){return e.jsxs("tr",{style:{background:"var(--c-azul-100)"},children:[e.jsx("td",{children:e.jsx("select",{value:s.dimension,onChange:t=>a({...s,dimension:t.target.value}),children:$.map(t=>e.jsx("option",{value:t.id,children:t.label},t.id))})}),e.jsx("td",{children:e.jsxs("select",{value:s.level,onChange:t=>a({...s,level:t.target.value}),children:[e.jsx("option",{value:"bajo",children:"Bajo"}),e.jsx("option",{value:"moderado",children:"Moderado"}),e.jsx("option",{value:"prioritario",children:"Prioritario"})]})}),e.jsx("td",{children:e.jsx("input",{value:s.title||"",onChange:t=>a({...s,title:t.target.value})})}),e.jsx("td",{children:e.jsx("textarea",{value:s.description||"",onChange:t=>a({...s,description:t.target.value})})}),e.jsx("td",{children:e.jsx("input",{type:"checkbox",checked:!!s.active,onChange:t=>a({...s,active:t.target.checked})})}),e.jsxs("td",{className:"actions-cell",children:[e.jsx("button",{className:"icon-btn primary",onClick:l,children:"✓"}),e.jsx("button",{className:"icon-btn",onClick:n,children:"✕"})]})]})}function ra({ctx:s}){const[a,l]=u.useState([]),[n,t]=u.useState(!0),[i,o]=u.useState(null),[r,d]=u.useState({});async function h(){t(!0);const{data:c}=await N.from("resources").select("*").order("name");l(c||[]),t(!1)}u.useEffect(()=>{h()},[]);function v(){o("new"),d({name:"",type:ie[0].id,description:"",audience:"",modality:"",location:"",schedule:"",contact:"",active:!0})}function x(c){o(c.id),d({...c})}async function f(){var c;if((c=r.name)!=null&&c.trim()){if(i==="new"){const{data:p}=await N.from("resources").insert(r).select().single();p&&await z({ctx:s,action:"create",entity:"resources",entity_id:p.id,after_data:p})}else{const p=a.find(y=>y.id===i),{error:_}=await N.from("resources").update(r).eq("id",i);_||await z({ctx:s,action:"update",entity:"resources",entity_id:i,before_data:p,after_data:r})}o(null),d({}),h()}}async function m(c){if(!confirm(`¿Eliminar recurso "${c.name}"?`))return;const{error:p}=await N.from("resources").delete().eq("id",c.id);p||await z({ctx:s,action:"delete",entity:"resources",entity_id:c.id,before_data:c}),h()}return n?e.jsx("div",{className:"spinner",style:{margin:"40px auto"}}):e.jsxs("div",{className:"panel",children:[e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center"},children:[e.jsxs("h2",{children:["Recursos universitarios (",a.length,")"]}),i!=="new"&&e.jsx("button",{className:"btn btn-primary btn-sm",onClick:v,children:"＋ Nuevo"})]}),i==="new"&&e.jsx(fe,{draft:r,setDraft:d,onSave:f,onCancel:()=>{o(null),d({})}}),e.jsx("div",{className:"cards-grid mt-3",children:a.map(c=>{var p;return i===c.id?e.jsx("div",{className:"rcard editing",children:e.jsx(fe,{draft:r,setDraft:d,onSave:f,onCancel:()=>{o(null),d({})},inline:!0})},c.id):e.jsxs("div",{className:"rcard",children:[e.jsx("span",{className:"tag",children:((p=ie.find(_=>_.id===c.type))==null?void 0:p.label)||c.type}),e.jsx("h3",{className:"mt-2",children:c.name}),e.jsx("p",{className:"note",children:c.description}),c.location&&e.jsxs("small",{children:["📍 ",c.location]}),c.schedule&&e.jsxs("small",{children:["🕐 ",c.schedule]}),c.contact&&e.jsxs("small",{children:["📞 ",c.contact]}),e.jsxs("div",{className:"actions-cell mt-2",children:[e.jsx("button",{className:"icon-btn",onClick:()=>x(c),children:"✎ Editar"}),e.jsx("button",{className:"icon-btn danger",onClick:()=>m(c),children:"🗑"}),e.jsx("span",{style:{marginLeft:"auto",padding:"4px 8px",background:c.active?"var(--c-salvia-100)":"var(--c-coral-100)",borderRadius:8,fontSize:"0.78rem",fontWeight:700},children:c.active?"Activo":"Inactivo"})]})]},c.id)})}),e.jsx("style",{children:`
      ...
      `})]})}function Me({data:s,x:a="day",y:l="total",label:n,height:t=220}){var m,c;if(!s||s.length===0)return e.jsx("div",{className:"chart-empty",children:"Sin datos suficientes."});const i=700,o=t,r=32,d=s.map(p=>Number(p[l]||0)),h=Math.max(1,...d),v=s.map((p,_)=>({x:r+_/Math.max(1,s.length-1)*(i-2*r),y:o-r-Number(p[l]||0)/h*(o-2*r),label:p[a],val:p[l]})),x=v.map((p,_)=>`${_===0?"M":"L"} ${p.x},${p.y}`).join(" "),f=`${x} L ${v[v.length-1].x},${o-r} L ${v[0].x},${o-r} Z`;return e.jsxs("svg",{viewBox:`0 0 ${i} ${o}`,className:"chart-svg",role:"img","aria-label":n,children:[e.jsx("defs",{children:e.jsxs("linearGradient",{id:"line-grad",x1:"0",x2:"0",y1:"0",y2:"1",children:[e.jsx("stop",{offset:"0%",stopColor:"#10243E",stopOpacity:"0.3"}),e.jsx("stop",{offset:"100%",stopColor:"#10243E",stopOpacity:"0"})]})}),[.25,.5,.75].map(p=>e.jsx("line",{x1:r,y1:r+p*(o-2*r),x2:i-r,y2:r+p*(o-2*r),stroke:"#E5E7EB",strokeDasharray:"4 4"},p)),e.jsx("path",{d:f,fill:"url(#line-grad)"}),e.jsx("path",{d:x,fill:"none",stroke:"#10243E",strokeWidth:"2"}),v.map((p,_)=>e.jsxs("g",{children:[e.jsx("circle",{cx:p.x,cy:p.y,r:"3.5",fill:"#C9A227",stroke:"#fff",strokeWidth:"1.5"}),e.jsxs("title",{children:[p.label,": ",p.val]})]},_)),e.jsx("text",{x:r,y:o-8,fontSize:"10",fill:"#6B7280",children:(m=v[0])==null?void 0:m.label}),e.jsx("text",{x:i-r,y:o-8,textAnchor:"end",fontSize:"10",fill:"#6B7280",children:(c=v[v.length-1])==null?void 0:c.label}),e.jsx("text",{x:r,y:r-8,fontSize:"10",fill:"#6B7280",children:h})]})}function Re({data:s,x:a="label",y:l="value",height:n=220,color:t="#1A3358"}){if(!s||s.length===0)return e.jsx("div",{className:"chart-empty",children:"Sin datos."});const i=700,o=n,r=32,d=s.map(x=>Number(x[l]||0)),h=Math.max(1,...d),v=(i-2*r)/s.length-8;return e.jsxs("svg",{viewBox:`0 0 ${i} ${o}`,className:"chart-svg",role:"img",children:[[.25,.5,.75].map(x=>e.jsx("line",{x1:r,y1:r+x*(o-2*r),x2:i-r,y2:r+x*(o-2*r),stroke:"#E5E7EB",strokeDasharray:"4 4"},x)),s.map((x,f)=>{const m=r+f*((i-2*r)/s.length)+4,c=Number(x[l]||0)/h*(o-2*r);return e.jsxs("g",{children:[e.jsx("rect",{x:m,y:o-r-c,width:v,height:c,fill:t,rx:"6",children:e.jsxs("title",{children:[x[a],": ",x[l]]})}),e.jsx("text",{x:m+v/2,y:o-10,textAnchor:"middle",fontSize:"9",fill:"#6B7280",children:String(x[a]).slice(0,12)}),e.jsx("text",{x:m+v/2,y:o-r-c-6,textAnchor:"middle",fontSize:"10",fontWeight:"700",fill:"#10243E",children:x[l]})]},f)})]})}function ca({data:s,height:a=280}){if(!s||s.length===0)return e.jsx("div",{className:"chart-empty",children:"Sin datos suficientes."});const l=700,n=a,t=36,i=["Dom","Lun","Mar","Mié","Jue","Vie","Sáb"],o=(l-t*1.5)/24,r=(n-t*1.5)/7,d=Math.max(1,...s.map(v=>v.total||0));function h(v){const x=v/d,f=Math.round(16+185*x),m=Math.round(36+126*x),c=Math.round(62+-23*x);return`rgb(${f},${m},${c})`}return e.jsxs("svg",{viewBox:`0 0 ${l} ${n}`,className:"chart-svg",children:[i.map((v,x)=>e.jsx("text",{x:t-8,y:t+(x+.6)*r,textAnchor:"end",fontSize:"10",fill:"#6B7280",children:v},v)),Array.from({length:24}).map((v,x)=>x%3===0?e.jsxs("text",{x:t+(x+.5)*o,y:n-12,textAnchor:"middle",fontSize:"9",fill:"#6B7280",children:[x,"h"]},x):null),Array.from({length:7}).flatMap((v,x)=>Array.from({length:24}).map((f,m)=>{const c=s.find(_=>_.day_of_week===x&&_.hour_of_day===m),p=(c==null?void 0:c.total)||0;return e.jsx("rect",{x:t+m*o,y:t+x*r,width:o-1.5,height:r-1.5,fill:p?h(p):"#F4F7FB",rx:"3",children:e.jsxs("title",{children:[i[x]," ",m,"h: ",p]})},`${x}-${m}`)}))]})}function da({segments:s,label:a}){if(!s||s.length===0)return e.jsx("div",{className:"chart-empty",children:"Sin datos."});const l=s.reduce((h,v)=>h+v.value,0)||1,n=100,t=100,i=80,o=50;let r=0;function d(h,v){const x=n+i*Math.cos(h-Math.PI/2),f=t+i*Math.sin(h-Math.PI/2),m=n+i*Math.cos(v-Math.PI/2),c=t+i*Math.sin(v-Math.PI/2),p=n+o*Math.cos(v-Math.PI/2),_=t+o*Math.sin(v-Math.PI/2),y=n+o*Math.cos(h-Math.PI/2),w=t+o*Math.sin(h-Math.PI/2),g=v-h>Math.PI?1:0;return`M ${x} ${f} A ${i} ${i} 0 ${g} 1 ${m} ${c} L ${p} ${_} A ${o} ${o} 0 ${g} 0 ${y} ${w} Z`}return e.jsxs("svg",{viewBox:"0 0 200 200",className:"chart-svg",style:{maxWidth:220},children:[s.map((h,v)=>{const x=r/l*Math.PI*2;r+=h.value;const f=r/l*Math.PI*2;return e.jsx("path",{d:d(x,f),fill:h.color,children:e.jsxs("title",{children:[h.label,": ",h.value," (",Math.round(h.value/l*100),"%)"]})},v)}),e.jsx("text",{x:n,y:t-4,textAnchor:"middle",fontSize:"22",fontWeight:"800",fill:"#10243E",children:l}),e.jsx("text",{x:n,y:t+14,textAnchor:"middle",fontSize:"10",fill:"#6B7280",children:a})]})}function ma({steps:s}){if(!s||s.length===0)return e.jsx("div",{className:"chart-empty",children:"Sin datos."});const a=700,l=60*s.length+20,n=Math.max(1,...s.map(t=>t.value));return e.jsx("svg",{viewBox:`0 0 ${a} ${l}`,className:"chart-svg",children:s.map((t,i)=>{const o=t.value/n*(a-100),r=(a-o)/2,d=i*60+10,h=n?Math.round(t.value/n*100):0;return e.jsxs("g",{children:[e.jsx("rect",{x:r,y:d,width:o,height:48,rx:"8",fill:`rgba(16,36,62,${.85-i*.15})`}),e.jsx("text",{x:a/2,y:d+22,textAnchor:"middle",fontSize:"13",fontWeight:"700",fill:"#fff",children:t.label}),e.jsxs("text",{x:a/2,y:d+40,textAnchor:"middle",fontSize:"11",fill:"rgba(255,255,255,0.85)",children:[t.value," (",h,"%)"]})]},i)})})}function ua(){var n,t,i,o;const[s,a]=u.useState({loading:!0});if(u.useEffect(()=>{(async()=>{try{const[r,d,h,v,x,f]=await Promise.all([N.from("view_sessions_timeline").select("*").limit(60),N.from("view_hourly_distribution").select("*"),N.from("view_question_variance").select("*"),N.from("view_completion_funnel").select("*").single(),N.from("assessment_sessions").select("general_level"),N.from("view_pumai_metrics").select("*").single()]),m={bajo:0,moderado:0,prioritario:0};for(const p of x.data||[])m[p.general_level]!==void 0&&m[p.general_level]++;const c=(r.data||[]).slice().reverse();a({loading:!1,timeline:c,heatmap:d.data||[],variance:h.data||[],funnel:v.data||{started:0,completed:0,abandoned:0},levels:m,pumai:f.data||{}})}catch(r){console.warn(r),a({loading:!1,error:r.message})}})()},[]),s.loading)return e.jsx("div",{className:"spinner",style:{margin:"40px auto"}});const l=(n=s.pumai)!=null&&n.total_calls?Math.round(s.pumai.gemini_count/s.pumai.total_calls*100):null;return e.jsxs(e.Fragment,{children:[e.jsx("header",{className:"page-head",children:e.jsxs("div",{children:[e.jsx("span",{className:"tag",children:"Analítica"}),e.jsx("h1",{className:"mt-2",children:"Estadísticas y tendencias"}),e.jsx("p",{className:"lede",children:"Métricas agregadas para entender el comportamiento de la comunidad y la salud del sistema."})]})}),e.jsxs("div",{className:"stats-grid",children:[e.jsxs("section",{className:"panel",children:[e.jsx("h2",{children:"Tendencia de sesiones (últimos días)"}),e.jsx(Me,{data:s.timeline,x:"day",y:"total",label:"Sesiones por día"})]}),e.jsxs("section",{className:"panel",children:[e.jsx("h2",{children:"Distribución por nivel"}),e.jsx(da,{label:"sesiones",segments:[{label:"Bajo",value:s.levels.bajo,color:"#8FB8A0"},{label:"Moderado",value:s.levels.moderado,color:"#C9A227"},{label:"Prioritario",value:s.levels.prioritario,color:"#D26B53"}]})]})]}),e.jsxs("section",{className:"panel mt-3",children:[e.jsx("h2",{children:"Embudo de completación"}),e.jsx(ma,{steps:[{label:"Sesiones iniciadas",value:s.funnel.started||0},{label:"Tests completados",value:s.funnel.completed||0}]}),s.funnel.abandoned>0&&e.jsxs("p",{className:"note",children:[s.funnel.abandoned," sesiones quedaron sin completar."]})]}),e.jsxs("section",{className:"panel mt-3",children:[e.jsx("h2",{children:"Heatmap de horarios"}),e.jsx("p",{className:"note",children:"Cuándo se hacen los tests (día de la semana × hora)."}),e.jsx(ca,{data:s.heatmap})]}),e.jsxs("section",{className:"panel mt-3",children:[e.jsx("h2",{children:"Preguntas con mayor varianza"}),e.jsx("p",{className:"note",children:"Reactivos que diferencian más a la población — los más informativos del instrumento."}),e.jsx(Re,{data:(s.variance||[]).slice(0,8).map(r=>({label:`#${r.sort_order}`,value:Number(r.stddev||0),tip:r.question_text})),x:"label",y:"value",color:"#C9A227"}),e.jsxs("details",{className:"mt-2",children:[e.jsx("summary",{children:"Ver detalles"}),e.jsx("ul",{style:{paddingLeft:20,fontSize:"0.9rem"},children:(s.variance||[]).slice(0,10).map(r=>e.jsxs("li",{children:[e.jsxs("strong",{children:["#",r.sort_order]})," (",r.dimension,", σ=",Number(r.stddev||0).toFixed(2),"): ",r.question_text]},r.question_id))})]})]}),e.jsxs("section",{className:"panel mt-3",children:[e.jsx("h2",{children:"Métricas de Pum-AI"}),e.jsxs("div",{className:"kpi-grid",children:[e.jsx(Z,{label:"Llamadas totales",value:((t=s.pumai)==null?void 0:t.total_calls)??0}),e.jsx(Z,{label:"Pum-AI exitosa",value:((i=s.pumai)==null?void 0:i.gemini_count)??0,accent:"sage"}),e.jsx(Z,{label:"Fallback local",value:((o=s.pumai)==null?void 0:o.fallback_count)??0,accent:"coral"}),e.jsx(Z,{label:"Tasa de éxito",value:l!=null?l+"%":"—",accent:"gold"})]})]}),e.jsx("style",{children:`
        .stats-grid {
          display: grid;
...
${n}`}function ga({ctx:s}){const[a,l]=u.useState(""),[n,t]=u.useState(null),[i,o]=u.useState(!1),[r,d]=u.useState(null);async function h(v){if(v==null||v.preventDefault(),!!a.trim()){o(!0),d(null),t(null);try{const{data:x,error:f}=await N.from("assessment_sessions").select("id, anonymous_code, total_score, general_level, dimension_scores, top_attention_areas, created_at").ilike("anonymous_code",`%${a.trim()}%`).order("created_at",{ascending:!1}).limit(20);if(f)throw f;t(x||[])}catch(x){d(x.message)}finally{o(!1)}}}return e.jsxs(e.Fragment,{children:[e.jsx("header",{className:"page-head",children:e.jsxs("div",{children:[e.jsx("span",{className:"tag",children:"Búsqueda"}),e.jsx("h1",{className:"mt-2",children:"Buscar por código anónimo"}),e.jsxs("p",{className:"lede",children:["Si una persona regresa con su código (ej. ",e.jsx("code",{children:"SIN-XJS-4278"}),"), aquí ves sus sesiones. Útil para acompañar evolución sin pedir datos personales."]})]})}),e.jsxs("form",{className:"panel",onSubmit:h,style:{display:"flex",gap:10,alignItems:"flex-end"},children:[e.jsxs("div",{className:"field",style:{flex:1,marginBottom:0},children:[e.jsx("label",{children:"Código anónimo"}),e.jsx("input",{value:a,onChange:v=>l(v.target.value.toUpperCase()),placeholder:"SIN-XXX-####",style:{fontFamily:"var(--ff-serif)",letterSpacing:"0.05em"}})]}),e.jsx("button",{className:"btn btn-primary",type:"submit",disabled:i,children:i?"Buscando…":"🔍 Buscar"})]}),r&&e.jsx("p",{className:"feedback error mt-2",children:r}),n&&e.jsxs("section",{className:"panel mt-3",children:[e.jsxs("h2",{children:["Resultados (",n.length,")"]}),n.length===0&&e.jsx("p",{className:"note",children:"No se encontraron sesiones con ese código."}),e.jsx("div",{className:"results-list",children:n.map(v=>e.jsx(ja,{session:v,ctx:s},v.id))})]}),e.jsx("style",{children:`
      ...
      `})]})}function va({ctx:s}){return e.jsxs(e.Fragment,{children:[e.jsx("header",{className:"page-head",children:e.jsxs("div",{children:[e.jsx("span",{className:"tag azul",children:"Sistema"}),e.jsx("h1",{className:"mt-2",children:"Configuración"}),e.jsx("p",{className:"lede",children:"Editor del prompt de Pum-AI y reglas de alertas operativas."})]})}),e.jsx(ba,{ctx:s}),e.jsx(fa,{ctx:s})]})}function ba({ctx:s}){const[a,l]=u.useState(null),[n,t]=u.useState(!0),[i,o]=u.useState(null);u.useEffect(()=>{r()},[]);async function r(){t(!0);const{data:h}=await N.from("system_config").select("*").eq("id","pumai_prompt").maybeSingle();l((h==null?void 0:h.data)||{}),t(!1)}async function d(){o(null);const{data:h}=await N.from("system_config").select("data").eq("id","pumai_prompt").single(),{error:v}=await N.from("system_config").upsert({id:"pumai_prompt",data:a,updated_by:s.admin.id,updated_at:new Date().toISOString()});v?o({type:"error",text:v.message}):(await z({ctx:s,action:"update",entity:"prompt",entity_id:"pumai_prompt",before_data:h==null?void 0:h.data,after_data:a}),o({type:"ok",text:"Configuración guardada. Tomará efecto en la siguiente invocación de la Edge Function."}))}return n?e.jsx("div",{className:"spinner",style:{margin:"24px auto"}}):e.jsxs("section",{className:"panel mt-3",children:[e.jsx("h2",{children:"Prompt de Pum-AI"}),e.jsx("p",{className:"note",children:"Define las reglas y tono que la IA debe seguir al generar la orientación. Cambios aplican a partir de la próxima sesión."}),e.jsxs("div",{className:"field mt-3",children:[e.jsx("label",{children:"Instrucción del sistema"}),e.jsx("textarea",{value:(a==null?void 0:a.system)||"",onChange:h=>l({...a,system:h.target.value}),rows:8})]}),e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:12},children:[e.jsxs("div",{className:"field",children:[e.jsx("label",{children:"Temperatura (0-1)"}),e.jsx("input",{type:"number",min:"0",max:"1",step:"0.05",value:(a==null?void 0:a.temperature)??.4,onChange:h=>l({...a,temperature:Number(h.target.value)})})]}),e.jsxs("div",{className:"field",children:[e.jsx("label",{children:"Max tokens"}),e.jsx("input",{type:"number",min:"256",max:"8192",step:"128",value:(a==null?void 0:a.max_tokens)??2048,onChange:h=>l({...a,max_tokens:Number(h.target.value)})})]}),e.jsxs("div",{className:"field",children:[e.jsx("label",{children:"Activado"}),e.jsxs("select",{value:a!=null&&a.enabled?"1":"0",onChange:h=>l({...a,enabled:h.target.value==="1"}),children:[e.jsx("option",{value:"1",children:"Sí"}),e.jsx("option",{value:"0",children:"No (solo fallback)"})]})]})]}),e.jsx("button",{className:"btn btn-primary",onClick:d,children:"Guardar"}),i&&e.jsx("p",{className:`feedback ${i.type}`,children:i.text}),e.jsxs("p",{className:"note mt-3",children:["⚠ Para que estos cambios tomen efecto, la Edge Function debe leer ",e.jsx("code",{children:"system_config"})," al iniciar cada llamada. Puedo enviarte la versión actualizada de la function que lo hace cuando me digas."]}),e.jsx("style",{children:`
        .feedback { padding: 10px 14px; border-radius: 12px; margin-top: 12px; font-size: 0.92rem; display: inline-block; }
        .feedback.ok    { background: var(--c-salvia-100); color: #2F8770; }
        .feedback.error { background: var(--c-coral-100); color: #93362A; }
      `})]})}function fa({ctx:s}){const[a,l]=u.useState(null),[n,t]=u.useState(!0),[i,o]=u.useState(null);u.useEffect(()=>{r()},[]);async function r(){t(!0);const{data:h}=await N.from("system_config").select("*").eq("id","alerts_rules").maybeSingle();l((h==null?void 0:h.data)||{priority_threshold:30,priority_window_days:7,notify_email:"",enabled:!1}),t(!1)}async function d(){o(null);const{data:h}=await N.from("system_config").select("data").eq("id","alerts_rules").single(),{error:v}=await N.from("system_config").upsert({id:"alerts_rules",data:a,updated_by:s.admin.id,updated_at:new Date().toISOString()});v?o({type:"error",text:v.message}):(await z({ctx:s,action:"update",entity:"alerts",entity_id:"alerts_rules",before_data:h==null?void 0:h.data,after_data:a}),o({type:"ok",text:"Reglas guardadas."}))}return n?null:e.jsxs("section",{className:"panel mt-3",children:[e.jsx("h2",{children:"Alertas operativas"}),e.jsx("p",{className:"note",children:"Define umbrales para que el sistema notifique cuando demasiadas sesiones llegan a nivel prioritario en una ventana de tiempo. (Las notificaciones por email requieren configurar el envío de email del backend con un proveedor SMTP — Fase 2.)"}),e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12,marginTop:12},children:[e.jsxs("div",{className:"field",children:[e.jsx("label",{children:"% de sesiones en nivel prioritario que disparan alerta"}),e.jsx("input",{type:"number",min:"1",max:"100",value:a.priority_threshold,onChange:h=>l({...a,priority_threshold:Number(h.target.value)})})]}),e.jsxs("div",{className:"field",children:[e.jsx("label",{children:"Ventana en días"}),e.jsx("input",{type:"number",min:"1",max:"90",value:a.priority_window_days,onChange:h=>l({...a,priority_window_days:Number(h.target.value)})})]}),e.jsxs("div",{className:"field",children:[e.jsx("label",{children:"Email de notificación"}),e.jsx("input",{type:"email",value:a.notify_email||"",onChange:h=>l({...a,notify_email:h.target.value}),placeholder:"alertas@unam.mx"})]}),e.jsxs("div",{className:"field",children:[e.jsx("label",{children:"Estado"}),e.jsxs("select",{value:a.enabled?"1":"0",onChange:h=>l({...a,enabled:h.target.value==="1"}),children:[e.jsx("option",{value:"0",children:"Desactivadas"}),e.jsx("option",{value:"1",children:"Activas"})]})]})]}),e.jsx("button",{className:"btn btn-primary mt-2",onClick:d,children:"Guardar"}),i&&e.jsx("p",{className:`feedback ${i.type}`,children:i.text})]})}function ya(){var p;const[s,a]=u.useState(null),[l,n]=u.useState(null),[t,i]=u.useState(null),[o,r]=u.useState([]),[d,h]=u.useState({}),[v,x]=u.useState(null);u.useEffect(()=>{N.from("view_pumai_cost").select("*").limit(30).then(({data:_})=>r(_||[])),Promise.all([N.from("ai_insights").select("*").eq("kind","executive_report").order("generated_at",{ascending:!1}).limit(1).maybeSingle(),N.from("ai_insights").select("*").eq("kind","qualitative_feedback").order("generated_at",{ascending:!1}).limit(1).maybeSingle(),N.from("ai_insights").select("*").eq("kind","anomaly_detection").order("generated_at",{ascending:!1}).limit(1).maybeSingle()]).then(([_,y,w])=>{var g,j,b;a((g=_.data)!=null&&g.data?{..._.data.data,generated_at:_.data.generated_at}:null),n((j=y.data)!=null&&j.data?{...y.data.data,generated_at:y.data.generated_at}:null),i((b=w.data)!=null&&b.data?{...w.data.data,generated_at:w.data.generated_at}:null)})},[]);async function f(_,y=!1){h(w=>({...w,[_]:!0})),x(null);try{const{data:w,error:g}=await N.functions.invoke("ai-insights",{body:{kind:_,cache:!y}});if(g)throw g;if(w!=null&&w.error)throw new Error(w.error);_==="executive_report"&&a(w),_==="qualitative_feedback"&&n(w),_==="anomaly_detection"&&i(w)}catch(w){x(`${_}: ${w.message}`)}finally{h(w=>({...w,[_]:!1}))}}const m=o.reduce((_,y)=>_+Number(y.cost_total_usd||0),0),c=o.reduce((_,y)=>_+(y.calls||0),0);return e.jsxs(e.Fragment,{children:[e.jsx("header",{className:"page-head",children:e.jsxs("div",{children:[e.jsx("span",{className:"tag",children:"Pum-AI Insights"}),e.jsx("h1",{className:"mt-2",children:"Inteligencia y costo del programa"}),e.jsx("p",{className:"lede",children:"Reportes ejecutivos, análisis cualitativo y detección de anomalías generados por Pum-AI. Los reportes se cachean 24h para no gastar créditos."})]})}),v&&e.jsx("p",{className:"feedback error",children:v}),e.jsxs("section",{className:"panel",children:[e.jsxs("header",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:8},children:[e.jsx("h2",{children:"📊 Reporte ejecutivo"}),e.jsx("div",{style:{display:"flex",gap:6},children:e.jsx("button",{className:"btn btn-ghost btn-sm",onClick:()=>f("executive_report",!0),disabled:d.executive_report,children:d.executive_report?"Generando…":"🔄 Regenerar"})})]}),s?e.jsx(_a,{data:s}):e.jsx("button",{className:"btn btn-primary mt-2",onClick:()=>f("executive_report"),disabled:d.executive_report,children:d.executive_report?"Generando…":"✨ Generar reporte ejecutivo"})]}),e.jsxs("section",{className:"panel mt-3",children:[e.jsxs("header",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:8},children:[e.jsx("h2",{children:"💬 Análisis cualitativo del feedback"}),e.jsx("button",{className:"btn btn-ghost btn-sm",onClick:()=>f("qualitative_feedback",!0),disabled:d.qualitative_feedback,children:d.qualitative_feedback?"Generando…":"🔄 Regenerar"})]}),l?e.jsx(Na,{data:l}):e.jsx("button",{className:"btn btn-primary mt-2",onClick:()=>f("qualitative_feedback"),disabled:d.qualitative_feedback,children:d.qualitative_feedback?"Generando…":"✨ Analizar comentarios"})]}),e.jsxs("section",{className:"panel mt-3",children:[e.jsxs("header",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:8},children:[e.jsx("h2",{children:"⚠️ Detección de anomalías"}),e.jsx("button",{className:"btn btn-ghost btn-sm",onClick:()=>f("anomaly_detection",!0),disabled:d.anomaly_detection,children:d.anomaly_detection?"Generando…":"🔄 Regenerar"})]}),t?e.jsx(wa,{data:t}):e.jsx("button",{className:"btn btn-primary mt-2",onClick:()=>f("anomaly_detection"),disabled:d.anomaly_detection,children:d.anomaly_detection?"Generando…":"✨ Detectar anomalías"})]}),e.jsxs("section",{className:"panel mt-3",children:[e.jsx("h2",{children:"💰 Consumo Pum-AI (últimos 30 días)"}),e.jsxs("div",{className:"kpi-grid mt-2",children:[e.jsx(te,{label:"Llamadas",value:c}),e.jsx(te,{label:"Costo USD",value:"$"+m.toFixed(4),accent:"gold"}),e.jsx(te,{label:"Modelo",value:((p=o[0])==null?void 0:p.model)||"gemini-2.5-flash"})]}),o.length>0&&e.jsx("div",{className:"table-wrap mt-2",children:e.jsxs("table",{className:"admin-table",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Día"}),e.jsx("th",{children:"Modelo"}),e.jsx("th",{children:"Llamadas"}),e.jsx("th",{children:"Tokens in"}),e.jsx("th",{children:"Tokens out"}),e.jsx("th",{children:"USD"})]})}),e.jsx("tbody",{children:o.slice(0,14).map((_,y)=>e.jsxs("tr",{children:[e.jsx("td",{children:_.day}),e.jsx("td",{children:e.jsx("code",{children:_.model})}),e.jsx("td",{children:_.calls}),e.jsx("td",{children:_.tokens_in}),e.jsx("td",{children:_.tokens_out}),e.jsxs("td",{children:["$",Number(_.cost_total_usd).toFixed(4)]})]},y))})]})}),e.jsx("p",{className:"note mt-2",children:"Precios estimados: gemini-2.5-flash ≈ $0.075/1M tokens entrada, $0.30/1M salida (USD)."})]}),e.jsx("style",{children:`
        .feedback.error { background: var(--c-coral-100); color: #93362A; padding: 10px 14px; border-radius: 12px; }
...
Esto resetea los rate limits de toda la plataforma. Útil cuando estás probando con tu propia conexión y quieres seguir registrando códigos.`)){i(!0),r(null);try{const m=new Date(Date.now()-864e5).toISOString(),[c,p]=await Promise.all([N.from("ip_log").delete().gte("created_at",m),N.from("ip_blocklist").delete().gte("blocked_at",m)]);if(c.error||p.error)throw new Error(((x=c.error)==null?void 0:x.message)||((f=p.error)==null?void 0:f.message));r("✅ Logs de IP y blocklist de las últimas 24h limpiados. Ya puedes volver a registrar."),d()}catch(m){r("❌ "+(m.message||"Error al resetear"))}finally{i(!1)}}}return e.jsxs("section",{className:"panel",children:[e.jsx("p",{className:"note",children:"IPs bloqueadas para nuevas operaciones públicas (registro/chat). Auto-bloqueo después de más de 5 registros en 24h."}),l?e.jsx("div",{className:"spinner",style:{margin:"24px auto"}}):s.length===0?e.jsx("p",{className:"note text-center",children:"Ninguna IP bloqueada. 🟢"}):e.jsx("div",{className:"table-wrap mt-2",children:e.jsxs("table",{className:"admin-table",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Hash"}),e.jsx("th",{children:"Razón"}),e.jsx("th",{children:"Bloqueada"}),e.jsx("th",{})]})}),e.jsx("tbody",{children:s.map(x=>e.jsxs("tr",{children:[e.jsx("td",{children:e.jsxs("code",{style:{fontSize:"0.74rem"},children:[x.ip_hash.slice(0,16),"…"]})}),e.jsx("td",{children:e.jsx("small",{children:x.reason})}),e.jsx("td",{children:new Date(x.blocked_at).toLocaleString("es-MX")}),e.jsx("td",{children:e.jsx("button",{className:"icon-btn",onClick:()=>h(x.ip_hash),children:"✓ Desbloquear y limpiar logs"})})]},x.ip_hash))})]})}),e.jsxs("div",{className:"testing-box mt-4",children:[e.jsx("h3",{children:"🧪 Modo testing — resetear rate limits"}),e.jsxs("p",{className:"note",children:["Cuando estás probando registros con tu propia IP y te auto-bloqueas, este botón limpia todos los logs y desbloqueos de las últimas 24h. ",e.jsx("strong",{children:"No usar en producción real."})]}),e.jsx("button",{className:"btn btn-ghost",onClick:v,disabled:t,children:t?"Reseteando…":"🧹 Resetear rate limits de las últimas 24h"}),o&&e.jsx("p",{className:"note mt-2",children:e.jsx("strong",{children:o})})]}),e.jsx("style",{children:`
      ...
      `})]})}function Da({ctx:s,hunt:a,onClose:l}){var f;const[n,t]=u.useState(a||{title:"",description:"",reward_label:"",reward_image:"",starts_at:"",ends_at:"",active:!0,clues:[]}),[i,o]=u.useState(!1);function r(){t(m=>{var c;return{...m,clues:[...m.clues||[],{clue_order:(((c=m.clues)==null?void 0:c.length)||0)+1,riddle:"",hint:"",unlock_after:"always"}]}})}function d(m,c,p){t(_=>({..._,clues:_.clues.map((y,w)=>w===m?{...y,[c]:p}:y)}))}function h(m){t(c=>({...c,clues:c.clues.filter((p,_)=>_!==m)}))}async function v(){o(!0);try{let m=a==null?void 0:a.id;const c={title:n.title,description:n.description,reward_label:n.reward_label,reward_image:n.reward_image,starts_at:n.starts_at,ends_at:n.ends_at,active:n.active};if(m){const{error:p}=await N.from("game_events").update(c).eq("id",m);if(p)throw p;await z({ctx:s,action:"update",entity:"game_events",entity_id:m,after_data:c})}else{const{data:p,error:_}=await N.from("game_events").insert(c).select().single();if(_)throw _;m=p.id,await z({ctx:s,action:"create",entity:"game_events",entity_id:m,after_data:p})}await N.from("game_clues").delete().eq("event_id",m);for(const p of n.clues)await N.from("game_clues").insert({event_id:m,clue_order:p.clue_order,riddle:p.riddle,hint:p.hint,unlock_after:p.unlock_after,reveal_at_lat:p.reveal_at_lat||null,reveal_at_lng:p.reveal_at_lng||null});l()}catch(m){alert(m.message)}finally{o(!1)}}async function x(){a!=null&&a.id&&confirm(`¿Eliminar la aventura "${a.title}"?`)&&(await N.from("game_events").delete().eq("id",a.id),await z({ctx:s,action:"delete",entity:"game_events",entity_id:a.id,before_data:a}),l())}return e.jsxs("div",{className:"overlay",onClick:l,children:[e.jsxs("div",{className:"modal",onClick:m=>m.stopPropagation(),children:[e.jsxs("header",{children:[e.jsx("h3",{children:a?"✏️ Editar aventura":"✨ Nueva aventura"}),e.jsx("button",{onClick:l,children:"✕"})]}),e.jsxs("div",{className:"grid-form",children:[e.jsxs("div",{className:"field",style:{gridColumn:"1/-1"},children:[e.jsx("label",{children:"Título"}),e.jsx("input",{value:n.title,onChange:m=>t({...n,title:m.target.value})})]}),e.jsxs("div",{className:"field",style:{gridColumn:"1/-1"},children:[e.jsx("label",{children:"Descripción"}),e.jsx("textarea",{value:n.description||"",onChange:m=>t({...n,description:m.target.value})})]}),e.jsxs("div",{className:"field",children:[e.jsx("label",{children:"Inicio"}),e.jsx("input",{type:"datetime-local",value:U(n.starts_at),onChange:m=>t({...n,starts_at:m.target.value})})]}),e.jsxs("div",{className:"field",children:[e.jsx("label",{children:"Fin"}),e.jsx("input",{type:"datetime-local",value:U(n.ends_at),onChange:m=>t({...n,ends_at:m.target.value})})]}),e.jsxs("div",{className:"field",style:{gridColumn:"1/-1"},children:[e.jsx("label",{children:"Recompensa"}),e.jsx("input",{value:n.reward_label||"",onChange:m=>t({...n,reward_label:m.target.value})})]}),e.jsxs("div",{className:"field",children:[e.jsx("label",{children:"Activo"}),e.jsxs("select",{value:n.active?"1":"0",onChange:m=>t({...n,active:m.target.value==="1"}),children:[e.jsx("option",{value:"1",children:"Sí"}),e.jsx("option",{value:"0",children:"No"})]})]})]}),e.jsx("h4",{className:"mt-3",children:"Pistas"}),((f=n.clues)==null?void 0:f.length)===0&&e.jsx("p",{className:"note",children:"Aún sin pistas. Agrega al menos 1."}),(n.clues||[]).map((m,c)=>e.jsxs("div",{className:"clue-edit",children:[e.jsxs("header",{children:[e.jsxs("strong",{children:["Pista #",m.clue_order]}),e.jsx("button",{onClick:()=>h(c),className:"icon-btn",children:"🗑"})]}),e.jsxs("div",{className:"grid-form",children:[e.jsxs("div",{className:"field",children:[e.jsx("label",{children:"Orden"}),e.jsx("input",{type:"number",value:m.clue_order,onChange:p=>d(c,"clue_order",Number(p.target.value))})]}),e.jsxs("div",{className:"field",children:[e.jsx("label",{children:"Desbloquea con"}),e.jsxs("select",{value:m.unlock_after||"always",onChange:p=>d(c,"unlock_after",p.target.value),children:[e.jsx("option",{value:"always",children:"Disponible al inicio"}),e.jsx("option",{value:"checkin_count:1",children:"1 check-in"}),e.jsx("option",{value:"checkin_count:2",children:"2 check-ins"}),e.jsx("option",{value:"checkin_count:3",children:"3 check-ins"}),e.jsx("option",{value:"wellness_route_done",children:"Completar ruta de bienestar"})]})]}),e.jsxs("div",{className:"field",style:{gridColumn:"1/-1"},children:[e.jsx("label",{children:"Adivinanza / pista"}),e.jsx("textarea",{value:m.riddle||"",onChange:p=>d(c,"riddle",p.target.value)})]}),e.jsxs("div",{className:"field",style:{gridColumn:"1/-1"},children:[e.jsx("label",{children:"Hint adicional (opcional)"}),e.jsx("input",{value:m.hint||"",onChange:p=>d(c,"hint",p.target.value)})]}),e.jsxs("div",{className:"field",children:[e.jsx("label",{children:"Lat (opcional)"}),e.jsx("input",{type:"number",step:"0.0001",value:m.reveal_at_lat||"",onChange:p=>d(c,"reveal_at_lat",p.target.value)})]}),e.jsxs("div",{className:"field",children:[e.jsx("label",{children:"Lng (opcional)"}),e.jsx("input",{type:"number",step:"0.0001",value:m.reveal_at_lng||"",onChange:p=>d(c,"reveal_at_lng",p.target.value)})]})]})]},c)),e.jsx("button",{className:"btn btn-ghost btn-sm mt-2",onClick:r,children:"＋ Agregar pista"}),e.jsxs("div",{style:{display:"flex",gap:8,marginTop:18},children:[e.jsx("button",{className:"btn btn-primary",onClick:v,disabled:i,children:i?"Guardando…":"✓ Guardar aventura"}),e.jsx("button",{className:"btn btn-ghost",onClick:l,children:"Cancelar"}),a&&e.jsx("button",{className:"btn btn-coral",onClick:x,style:{marginLeft:"auto"},children:"🗑 Eliminar"})]})]}),e.jsx("style",{children:`
