import{j as e,u as N,b as j,s as z}from"./index-D0XEUpzS.js";import{r as o,b as k,L as S}from"./vendor-react-Be-nUyB0.js";import"./vendor-supabase-J7ITh-P0.js";function E({children:t,speed:u=32,startDelay:l=0,cursor:p=!0,onDone:n,as:b="span",className:h="",style:y={}}){const a=typeof t=="string"?t:String(t),[m,x]=o.useState(0);o.useEffect(()=>{var s;if((s=window.matchMedia)!=null&&s.call(window,"(prefers-reduced-motion: reduce)").matches){x(a.length),n==null||n();return}let c;const f=setTimeout(()=>{let i=0;c=setInterval(()=>{i++,x(i),i>=a.length&&(clearInterval(c),n==null||n())},u)},l);return()=>{clearTimeout(f),c&&clearInterval(c)}},[a,u,l]);const g=m>=a.length;return e.jsxs(b,{className:`typewriter ${h}`,style:y,"aria-label":a,children:[e.jsx("span",{"aria-hidden":"true",children:a.slice(0,m)}),p&&!g&&e.jsx("span",{className:"tw-cursor",children:"▍"}),e.jsx("style",{children:`
        .tw-cursor {
