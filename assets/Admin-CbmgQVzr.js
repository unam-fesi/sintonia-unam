import{j as e,s as N,D as $,R as ie,C as ae,S as Ie,e as qe,h as Le,i as Pe,b as O,k as $e}from"./index-OEocqfh1.js";import{r as u,N as W,L as Fe,d as Ae,b as Te,R as De,c as R}from"./vendor-react-Be-nUyB0.js";import{R as ze,s as Be,c as Y,g as de}from"./authService-ChXpQBNM.js";import{I as re}from"./Icon-CsFa-FTY.js";import"./vendor-supabase-J7ITh-P0.js";const me={estado_emocional:["#1A3358","#10243E"],estres_academico:["#D26B53","#B5403E"],sueno_descanso:["#B7A8D9","#6E5BA0"],apoyo_social:["#8FB8A0","#4FA88E"],motivacion_pertenencia:["#E5C868","#B08F1F"]},ue=["#1A3358","#10243E"],le=720,oe=460,J=le/2,K=oe/2,Q=160,he=600,Oe=18e-5;function Ue(s,a){const l=parseInt(s.slice(1),16),n=Math.min(255,(l>>16&255)+Math.round(2.55*a)),t=Math.min(255,(l>>8&255)+Math.round(2.55*a)),i=Math.min(255,(l&255)+Math.round(2.55*a));return`#${(n<<16|t<<8|i).toString(16).padStart(6,"0")}`}function We({data:s=[]}){const a=u.useRef(null),l=u.useRef({rotY:0,rotX:.25}),[n,t]=u.useState(0),[i,o]=u.useState(null),r=u.useMemo(()=>{const f=s.length||1;return s.map((k,C)=>{const E=Math.acos(1-2*(C+.5)/f),L=Math.PI*(1+Math.sqrt(5))*C;return{...k,p:{x:Math.sin(E)*Math.cos(L),y:Math.sin(E)*Math.sin(L),z:Math.cos(E)}}})},[s]),d=Math.max(1,...s.map(f=>f.mentions||0)),p=Math.min(...s.map(f=>f.mentions||0)),v=f=>d===p?38:30+(f-p)/(d-p)*28;u.useEffect(()=>{let f,k=performance.now();const C=E=>{const L=E-k;k=E,i||(l.current.rotY+=L*Oe),t(B=>B+1),f=requestAnimationFrame(C)};return f=requestAnimationFrame(C),()=>cancelAnimationFrame(f)},[i]);function h(f){var E,L;f.preventDefault();const{rotX:k,rotY:C}=l.current;o({startX:f.clientX,startY:f.clientY,startRotX:k,startRotY:C}),(L=(E=f.currentTarget).setPointerCapture)==null||L.call(E,f.pointerId)}function b(f){if(!i)return;const k=f.clientX-i.startX,C=f.clientY-i.startY;l.current.rotY=i.startRotY+k*.006,l.current.rotX=Xe(i.startRotX+C*.005,-1.2,1.2)}function m(f){var k,C;(C=(k=f.currentTarget).releasePointerCapture)==null||C.call(k,f.pointerId),o(null)}const{rotX:c,rotY:x}=l.current,_=Math.cos(x),y=Math.sin(x),w=Math.cos(c),g=Math.sin(c),j=r.map(f=>{const{x:k,y:C,z:E}=f.p,L=k*_+E*y,B=-k*y+E*_,S=C,M=S*w-B*g,A=S*g+B*w,q=L,F=A*Q,P=he/(he-F);return{...f,sx:J+q*Q*P,sy:K+M*Q*P,depth:A,scale:P}});return j.sort((f,k)=>f.depth-k.depth),s.length?e.jsxs("div",{className:"bubbles-wrap",children:[e.jsxs("svg",{ref:a,viewBox:`0 0 ${le} ${oe}`,className:`bubbles-svg ${i?"dragging":""}`,role:"img","aria-label":"Modelo dimensional 3D del bienestar",onPointerDown:h,onPointerMove:b,onPointerUp:m,onPointerCancel:m,style:{cursor:i?"grabbing":"grab",touchAction:"none"},children:[e.jsxs("defs",{children:[j.map(f=>{const[k,C]=me[f.dimension_id]||ue;return e.jsxs("radialGradient",{id:`grad-${f.dimension_id}`,cx:"32%",cy:"28%",r:"75%",children:[e.jsx("stop",{offset:"0%",stopColor:Ue(k,35)}),e.jsx("stop",{offset:"55%",stopColor:k}),e.jsx("stop",{offset:"100%",stopColor:C})]},`grad-${f.dimension_id}`)}),e.jsx("filter",{id:"bubble-shadow",x:"-30%",y:"-30%",width:"160%",height:"160%",children:e.jsx("feDropShadow",{dx:"0",dy:"8",stdDeviation:"14",floodColor:"#10243E",floodOpacity:"0.30"})}),e.jsxs("radialGradient",{id:"aura",cx:"50%",cy:"50%",r:"50%",children:[e.jsx("stop",{offset:"0%",stopColor:"#C9A227",stopOpacity:"0.18"}),e.jsx("stop",{offset:"60%",stopColor:"#C9A227",stopOpacity:"0.05"}),e.jsx("stop",{offset:"100%",stopColor:"#C9A227",stopOpacity:"0"})]})]}),e.jsx("circle",{cx:J,cy:K,r:Q+60,fill:"url(#aura)"}),e.jsx("circle",{cx:J,cy:K,r:"10",fill:"#C9A227",opacity:"0.85"}),e.jsx("text",{x:J,y:K+26,textAnchor:"middle",fontSize:"11",fill:"#10243E",fontWeight:"700",style:{userSelect:"none",pointerEvents:"none"},children:"AURA"}),j.map(f=>{const k=v(f.mentions||0)*f.scale,C=.55+(f.depth+1)*.225;return e.jsxs("g",{transform:`translate(${f.sx}, ${f.sy})`,style:{opacity:C},children:[e.jsx("circle",{r:k,fill:`url(#grad-${f.dimension_id})`,filter:"url(#bubble-shadow)"}),e.jsx("ellipse",{cx:-k*.32,cy:-k*.42,rx:k*.34,ry:k*.18,fill:"white",opacity:"0.35"}),f.depth>-.1&&e.jsxs(e.Fragment,{children:[e.jsx("text",{y:k+16,textAnchor:"middle",fontSize:"11",fontWeight:"700",fill:"#10243E",style:{userSelect:"none",pointerEvents:"none"},children:f.dimension_label||f.dimension_id}),e.jsxs("text",{y:k+28,textAnchor:"middle",fontSize:"9",fill:"#6B7280",style:{userSelect:"none",pointerEvents:"none"},children:[f.mentions," ",f.mentions===1?"mención":"menciones"]})]})]},f.dimension_id)}),e.jsx("text",{x:le-12,y:oe-12,textAnchor:"end",fontSize:"10",fill:"#9CA3AF",style:{userSelect:"none",pointerEvents:"none"},children:i?"Soltando para volver a animación":"Arrastra para rotar ↻"})]}),e.jsx("div",{className:"bubbles-legend",children:s.map(f=>{const[k]=me[f.dimension_id]||ue;return e.jsxs("div",{className:"legend-item",children:[e.jsx("span",{className:"legend-dot",style:{background:k}}),e.jsxs("div",{children:[e.jsx("strong",{children:f.dimension_label}),e.jsxs("small",{children:[f.mentions," ",f.mentions===1?"mención":"menciones"," · ","Promedio: ",f.avg_score]})]})]},f.dimension_id)})}),e.jsx("style",{children:`
        .bubbles-wrap {
          display: grid;
      ...
      `})]})}const Ze=[{id:"bajo",label:"Bajo (mantener)"},{id:"moderado",label:"Moderado (ajustar)"},{id:"prioritario",label:"Prioritario (acompañar)"}],ea=[{id:"autocuidado",label:"Autocuidado individual"},{id:"comunidad",label:"Comunidad / grupal"},{id:"ejercicio",label:"Ejercicio físico"},{id:"mindfulness",label:"Mindfulness / respiración"},{id:"arte",label:"Arte y expresión"},{id:"orientacion",label:"Orientación profesional"}];function aa({onUse:s}){const[a,l]=u.useState(!1),[n,t]=u.useState($[0].id),[i,o]=u.useState("moderado"),[r,d]=u.useState("autocuidado"),[p,v]=u.useState(3),[h,b]=u.useState(!1),[m,c]=u.useState([]),[x,_]=u.useState(null);async function y(){b(!0),_(null),c([]);try{const{data:g,error:j}=await N.functions.invoke("suggest-recommendations",{body:{dimension:n,level:i,type:r,count:p}});if(j)throw j;if(g!=null&&g.error)throw new Error(g.error);c((g==null?void 0:g.suggestions)||[])}catch(g){_((g==null?void 0:g.message)||"No pudimos generar sugerencias.")}finally{b(!1)}}function w(g){s==null||s({...g,dimension:n,level:i}),l(!1)}return e.jsxs(e.Fragment,{children:[e.jsx("button",{className:"btn btn-gold btn-sm",onClick:()=>l(!0),children:"✨ Sugerir con Pum-AI"}),a&&e.jsx("div",{className:"pumai-overlay",onClick:()=>l(!1),children:e.jsxs("div",{className:"pumai-modal",onClick:g=>g.stopPropagation(),children:[e.jsxs("header",{children:[e.jsx("h3",{children:"✨ Pum-AI · Sugerir recomendaciones"}),e.jsx("button",{className:"close",onClick:()=>l(!1),children:"✕"})]}),e.jsxs("div",{className:"form-grid",children:[e.jsxs("div",{className:"field",children:[e.jsx("label",{children:"Dimensión"}),e.jsx("select",{value:n,onChange:g=>t(g.target.value),children:$.map(g=>e.jsx("option",{value:g.id,children:g.label},g.id))})]}),e.jsxs("div",{className:"field",children:[e.jsx("label",{children:"Nivel de atención"}),e.jsx("select",{value:i,onChange:g=>o(g.target.value),children:Ze.map(g=>e.jsx("option",{value:g.id,children:g.label},g.id))})]}),e.jsxs("div",{className:"field",children:[e.jsx("label",{children:"Tipo de acción"}),e.jsx("select",{value:r,onChange:g=>d(g.target.value),children:ea.map(g=>e.jsx("option",{value:g.id,children:g.label},g.id))})]}),e.jsxs("div",{className:"field",children:[e.jsx("label",{children:"Cantidad"}),e.jsx("input",{type:"number",min:"1",max:"6",value:p,onChange:g=>v(Number(g.target.value))})]})]}),e.jsx("button",{className:"btn btn-primary",onClick:y,disabled:h,children:h?"Generando con Pum-AI…":"✨ Generar sugerencias"}),x&&e.jsx("p",{className:"error",children:x}),m.length>0&&e.jsxs("div",{className:"results",children:[e.jsxs("h4",{children:["Sugerencias (",m.length,")"]}),m.map((g,j)=>e.jsxs("article",{className:"suggestion",children:[e.jsx("strong",{children:g.title}),e.jsx("p",{children:g.description}),e.jsx("button",{className:"btn btn-coral btn-sm",onClick:()=>w(g),children:"＋ Usar esta"})]},j)),e.jsx("p",{className:"note text-center mt-2",children:"Revisa cada sugerencia antes de guardarla."})]})]})}),e.jsx("style",{children:`
        .pumai-overlay {
          position: fixed; inset: 0;
          background: rgba(10, 25, 41, 0.6);
          backdrop-filter: blur(4px);
      ...
      `})]})}function na({ctx:s}){const[a,l]=u.useState([]),[n,t]=u.useState(null),[i,o]=u.useState({}),[r,d]=u.useState(!0),[p,v]=u.useState({key:"sort_order",dir:"asc"});async function h(){d(!0);const{data:j}=await N.from("questions").select("*");l(j||[]),d(!1)}u.useEffect(()=>{h()},[]);function b(j){v(f=>f.key===j?{key:j,dir:f.dir==="asc"?"desc":"asc"}:{key:j,dir:"asc"})}const m=[...a].sort((j,f)=>{const k=j[p.key],C=f[p.key];if(k===C)return 0;if(k==null)return 1;if(C==null)return-1;const E=typeof k=="number"?k-C:String(k).localeCompare(String(C));return p.dir==="asc"?E:-E});function c(){const j=a.length?Math.max(...a.map(f=>f.sort_order))+1:1;t("new"),o({sort_order:j,dimension:$[0].id,question_text:"",is_reverse_scored:!1,active:!0})}function x(j){const f=a.length?Math.max(...a.map(k=>k.sort_order))+1:1;t("new"),o({sort_order:f,dimension:j.dimension||$[0].id,question_text:j.question_text,is_reverse_scored:!!j.is_reverse_scored,active:!0})}function _(j){t(j.id),o({...j})}async function y(){var j;if((j=i.question_text)!=null&&j.trim()){if(n==="new"){const{data:f,error:k}=await N.from("questions").insert(i).select().single();k||await z({ctx:s,action:"create",entity:"questions",entity_id:f.id,after_data:f})}else{const f=a.find(C=>C.id===n),{error:k}=await N.from("questions").update(i).eq("id",n);k||await z({ctx:s,action:"update",entity:"questions",entity_id:n,before_data:f,after_data:i})}t(null),o({}),h()}}async function w(j){const{error:f}=await N.from("questions").update({active:!j.active}).eq("id",j.id);f||await z({ctx:s,action:"toggle",entity:"questions",entity_id:j.id,before_data:{active:j.active},after_data:{active:!j.active}}),h()}async function g(j){if(!confirm(`¿Eliminar pregunta #${j.sort_order}?

"${j.question_text}"`))return;const{error:f}=await N.from("questions").delete().eq("id",j.id);f||await z({ctx:s,action:"delete",entity:"questions",entity_id:j.id,before_data:j}),h()}return r?e.jsx("div",{className:"spinner",style:{margin:"40px auto"}}):e.jsxs("div",{className:"panel",children:[e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",gap:8,flexWrap:"wrap"},children:[e.jsxs("h2",{children:["Banco de preguntas (",a.length,")"]}),e.jsxs("div",{style:{display:"flex",gap:8},children:[e.jsx(Qe,{onUse:x}),n!=="new"&&e.jsx("button",{className:"btn btn-primary btn-sm",onClick:c,children:"＋ Nueva"})]})]}),n==="new"&&e.jsx(ve,{draft:i,setDraft:o,onSave:y,onCancel:()=>{t(null),o({})}}),e.jsx("div",{className:"table-wrap mt-3",style:{overflowX:"auto"},children:e.jsxs("table",{className:"editor-table",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{style:{width:48},children:e.jsx(G,{k:"sort_order",sortBy:p,onSort:b,children:"#"})}),e.jsx("th",{children:e.jsx(G,{k:"question_text",sortBy:p,onSort:b,children:"Texto"})}),e.jsx("th",{style:{width:160},children:e.jsx(G,{k:"dimension",sortBy:p,onSort:b,children:"Dimensión"})}),e.jsx("th",{style:{width:80},children:e.jsx(G,{k:"is_reverse_scored",sortBy:p,onSort:b,children:"Inversa"})}),e.jsx("th",{style:{width:80},children:e.jsx(G,{k:"active",sortBy:p,onSort:b,children:"Activa"})}),e.jsx("th",{style:{width:140}})]})}),e.jsx("tbody",{children:m.map(j=>{var f;return n===j.id?e.jsx(ve,{draft:i,setDraft:o,onSave:y,onCancel:()=>{t(null),o({})}},j.id):e.jsxs("tr",{children:[e.jsx("td",{children:j.sort_order}),e.jsx("td",{children:j.question_text}),e.jsx("td",{children:((f=$.find(k=>k.id===j.dimension))==null?void 0:f.label)||j.dimension}),e.jsx("td",{children:j.is_reverse_scored?"✔":"—"}),e.jsx("td",{children:j.active?"✅":"⏸"}),e.jsxs("td",{className:"actions-cell",children:[e.jsx("button",{className:"icon-btn",onClick:()=>_(j),children:"✎"}),e.jsx("button",{className:"icon-btn",onClick:()=>w(j),children:j.active?"⏸":"▶"}),e.jsx("button",{className:"icon-btn danger",onClick:()=>g(j),children:"🗑"})]})]},j.id)})})]})})]})}function ve({draft:s,setDraft:a,onSave:l,onCancel:n}){return e.jsxs("tr",{style:{background:"var(--c-azul-100)"},children:[e.jsx("td",{children:e.jsx("input",{type:"number",min:"1",value:s.sort_order||1,onChange:t=>a({...s,sort_order:Number(t.target.value)})})}),e.jsx("td",{children:e.jsx("textarea",{value:s.question_text||"",onChange:t=>a({...s,question_text:t.target.value}),placeholder:"¿Pregunta?"})}),e.jsx("td",{children:e.jsx("select",{value:s.dimension,onChange:t=>a({...s,dimension:t.target.value}),children:$.map(t=>e.jsx("option",{value:t.id,children:t.label},t.id))})}),e.jsx("td",{children:e.jsx("input",{type:"checkbox",checked:!!s.is_reverse_scored,onChange:t=>a({...s,is_reverse_scored:t.target.checked})})}),e.jsx("td",{children:e.jsx("input",{type:"checkbox",checked:!!s.active,onChange:t=>a({...s,active:t.target.checked})})}),e.jsxs("td",{className:"actions-cell",children:[e.jsx("button",{className:"icon-btn primary",onClick:l,children:"✓"}),e.jsx("button",{className:"icon-btn",onClick:n,children:"✕"})]})]})}function ia({ctx:s}){const[a,l]=u.useState([]),[n,t]=u.useState(!0),[i,o]=u.useState(null),[r,d]=u.useState({});async function p(){t(!0);const{data:x}=await N.from("recommendations").select("*").order("dimension").order("level");l(x||[]),t(!1)}u.useEffect(()=>{p()},[]);function v(){o("new"),d({dimension:$[0].id,level:"bajo",title:"",description:"",active:!0})}function h(x){o(x.id),d({...x})}function b(x){o("new"),d({dimension:x.dimension||$[0].id,level:x.level||"moderado",title:x.title,description:x.description,active:!0})}async function m(){var x;if((x=r.title)!=null&&x.trim()){if(i==="new"){const{data:_}=await N.from("recommendations").insert(r).select().single();_&&await z({ctx:s,action:"create",entity:"recommendations",entity_id:_.id,after_data:_})}else{const _=a.find(w=>w.id===i),{error:y}=await N.from("recommendations").update(r).eq("id",i);y||await z({ctx:s,action:"update",entity:"recommendations",entity_id:i,before_data:_,after_data:r})}o(null),d({}),p()}}async function c(x){if(!confirm(`¿Eliminar recomendación "${x.title}"?`))return;const{error:_}=await N.from("recommendations").delete().eq("id",x.id);_||await z({ctx:s,action:"delete",entity:"recommendations",entity_id:x.id,before_data:x}),p()}return n?e.jsx("div",{className:"spinner",style:{margin:"40px auto"}}):e.jsxs("div",{className:"panel",children:[e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",gap:8,flexWrap:"wrap"},children:[e.jsxs("h2",{children:["Catálogo de recomendaciones (",a.length,")"]}),e.jsxs("div",{style:{display:"flex",gap:8},children:[e.jsx(aa,{onUse:b}),i!=="new"&&e.jsx("button",{className:"btn btn-primary btn-sm",onClick:v,children:"＋ Nueva"})]})]}),i==="new"&&e.jsx(fe,{draft:r,setDraft:d,onSave:m,onCancel:()=>{o(null),d({})}}),e.jsx("div",{className:"table-wrap mt-3",style:{overflowX:"auto"},children:e.jsxs("table",{className:"editor-table",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{style:{width:160},children:"Dimensión"}),e.jsx("th",{style:{width:120},children:"Nivel"}),e.jsx("th",{children:"Título"}),e.jsx("th",{children:"Descripción"}),e.jsx("th",{style:{width:80},children:"Activa"}),e.jsx("th",{style:{width:120}})]})}),e.jsx("tbody",{children:a.map(x=>{var _;return i===x.id?e.jsx(fe,{draft:r,setDraft:d,onSave:m,onCancel:()=>{o(null),d({})}},x.id):e.jsxs("tr",{children:[e.jsx("td",{children:((_=$.find(y=>y.id===x.dimension))==null?void 0:_.label)||x.dimension}),e.jsx("td",{children:e.jsx("span",{className:`lvl-bg-${x.level}`,style:{padding:"3px 8px",borderRadius:6,fontSize:"0.78rem",fontWeight:700},children:x.level})}),e.jsx("td",{children:x.title}),e.jsx("td",{children:e.jsx("small",{className:"note",children:x.description})}),e.jsx("td",{children:x.active?"✅":"⏸"}),e.jsxs("td",{className:"actions-cell",children:[e.jsx("button",{className:"icon-btn",onClick:()=>h(x),children:"✎"}),e.jsx("button",{className:"icon-btn danger",onClick:()=>c(x),children:"🗑"})]})]},x.id)})})]})})]})}function fe({draft:s,setDraft:a,onSave:l,onCancel:n}){return e.jsxs("tr",{style:{background:"var(--c-azul-100)"},children:[e.jsx("td",{children:e.jsx("select",{value:s.dimension,onChange:t=>a({...s,dimension:t.target.value}),children:$.map(t=>e.jsx("option",{value:t.id,children:t.label},t.id))})}),e.jsx("td",{children:e.jsxs("select",{value:s.level,onChange:t=>a({...s,level:t.target.value}),children:[e.jsx("option",{value:"bajo",children:"Bajo"}),e.jsx("option",{value:"moderado",children:"Moderado"}),e.jsx("option",{value:"prioritario",children:"Prioritario"})]})}),e.jsx("td",{children:e.jsx("input",{value:s.title||"",onChange:t=>a({...s,title:t.target.value})})}),e.jsx("td",{children:e.jsx("textarea",{value:s.description||"",onChange:t=>a({...s,description:t.target.value})})}),e.jsx("td",{children:e.jsx("input",{type:"checkbox",checked:!!s.active,onChange:t=>a({...s,active:t.target.checked})})}),e.jsxs("td",{className:"actions-cell",children:[e.jsx("button",{className:"icon-btn primary",onClick:l,children:"✓"}),e.jsx("button",{className:"icon-btn",onClick:n,children:"✕"})]})]})}function ra({ctx:s}){const[a,l]=u.useState([]),[n,t]=u.useState(!0),[i,o]=u.useState(null),[r,d]=u.useState({});async function p(){t(!0);const{data:c}=await N.from("resources").select("*").order("name");l(c||[]),t(!1)}u.useEffect(()=>{p()},[]);function v(){o("new"),d({name:"",type:ie[0].id,description:"",audience:"",modality:"",location:"",schedule:"",contact:"",active:!0})}function h(c){o(c.id),d({...c})}async function b(){var c;if((c=r.name)!=null&&c.trim()){if(i==="new"){const{data:x}=await N.from("resources").insert(r).select().single();x&&await z({ctx:s,action:"create",entity:"resources",entity_id:x.id,after_data:x})}else{const x=a.find(y=>y.id===i),{error:_}=await N.from("resources").update(r).eq("id",i);_||await z({ctx:s,action:"update",entity:"resources",entity_id:i,before_data:x,after_data:r})}o(null),d({}),p()}}async function m(c){if(!confirm(`¿Eliminar recurso "${c.name}"?`))return;const{error:x}=await N.from("resources").delete().eq("id",c.id);x||await z({ctx:s,action:"delete",entity:"resources",entity_id:c.id,before_data:c}),p()}return n?e.jsx("div",{className:"spinner",style:{margin:"40px auto"}}):e.jsxs("div",{className:"panel",children:[e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center"},children:[e.jsxs("h2",{children:["Recursos universitarios (",a.length,")"]}),i!=="new"&&e.jsx("button",{className:"btn btn-primary btn-sm",onClick:v,children:"＋ Nuevo"})]}),i==="new"&&e.jsx(be,{draft:r,setDraft:d,onSave:b,onCancel:()=>{o(null),d({})}}),e.jsx("div",{className:"cards-grid mt-3",children:a.map(c=>{var x;return i===c.id?e.jsx("div",{className:"rcard editing",children:e.jsx(be,{draft:r,setDraft:d,onSave:b,onCancel:()=>{o(null),d({})},inline:!0})},c.id):e.jsxs("div",{className:"rcard",children:[e.jsx("span",{className:"tag",children:((x=ie.find(_=>_.id===c.type))==null?void 0:x.label)||c.type}),e.jsx("h3",{className:"mt-2",children:c.name}),e.jsx("p",{className:"note",children:c.description}),c.location&&e.jsxs("small",{children:["📍 ",c.location]}),c.schedule&&e.jsxs("small",{children:["🕐 ",c.schedule]}),c.contact&&e.jsxs("small",{children:["📞 ",c.contact]}),e.jsxs("div",{className:"actions-cell mt-2",children:[e.jsx("button",{className:"icon-btn",onClick:()=>h(c),children:"✎ Editar"}),e.jsx("button",{className:"icon-btn danger",onClick:()=>m(c),children:"🗑"}),e.jsx("span",{style:{marginLeft:"auto",padding:"4px 8px",background:c.active?"var(--c-salvia-100)":"var(--c-coral-100)",borderRadius:8,fontSize:"0.78rem",fontWeight:700},children:c.active?"Activo":"Inactivo"})]})]},c.id)})}),e.jsx("style",{children:`
      ...
      `})]})}function Me({data:s,x:a="day",y:l="total",label:n,height:t=220}){var m,c;if(!s||s.length===0)return e.jsx("div",{className:"chart-empty",children:"Sin datos suficientes."});const i=700,o=t,r=32,d=s.map(x=>Number(x[l]||0)),p=Math.max(1,...d),v=s.map((x,_)=>({x:r+_/Math.max(1,s.length-1)*(i-2*r),y:o-r-Number(x[l]||0)/p*(o-2*r),label:x[a],val:x[l]})),h=v.map((x,_)=>`${_===0?"M":"L"} ${x.x},${x.y}`).join(" "),b=`${h} L ${v[v.length-1].x},${o-r} L ${v[0].x},${o-r} Z`;return e.jsxs("svg",{viewBox:`0 0 ${i} ${o}`,className:"chart-svg",role:"img","aria-label":n,children:[e.jsx("defs",{children:e.jsxs("linearGradient",{id:"line-grad",x1:"0",x2:"0",y1:"0",y2:"1",children:[e.jsx("stop",{offset:"0%",stopColor:"#10243E",stopOpacity:"0.3"}),e.jsx("stop",{offset:"100%",stopColor:"#10243E",stopOpacity:"0"})]})}),[.25,.5,.75].map(x=>e.jsx("line",{x1:r,y1:r+x*(o-2*r),x2:i-r,y2:r+x*(o-2*r),stroke:"#E5E7EB",strokeDasharray:"4 4"},x)),e.jsx("path",{d:b,fill:"url(#line-grad)"}),e.jsx("path",{d:h,fill:"none",stroke:"#10243E",strokeWidth:"2"}),v.map((x,_)=>e.jsxs("g",{children:[e.jsx("circle",{cx:x.x,cy:x.y,r:"3.5",fill:"#C9A227",stroke:"#fff",strokeWidth:"1.5"}),e.jsxs("title",{children:[x.label,": ",x.val]})]},_)),e.jsx("text",{x:r,y:o-8,fontSize:"10",fill:"#6B7280",children:(m=v[0])==null?void 0:m.label}),e.jsx("text",{x:i-r,y:o-8,textAnchor:"end",fontSize:"10",fill:"#6B7280",children:(c=v[v.length-1])==null?void 0:c.label}),e.jsx("text",{x:r,y:r-8,fontSize:"10",fill:"#6B7280",children:p})]})}function Re({data:s,x:a="label",y:l="value",height:n=220,color:t="#1A3358"}){if(!s||s.length===0)return e.jsx("div",{className:"chart-empty",children:"Sin datos."});const i=700,o=n,r=32,d=s.map(h=>Number(h[l]||0)),p=Math.max(1,...d),v=(i-2*r)/s.length-8;return e.jsxs("svg",{viewBox:`0 0 ${i} ${o}`,className:"chart-svg",role:"img",children:[[.25,.5,.75].map(h=>e.jsx("line",{x1:r,y1:r+h*(o-2*r),x2:i-r,y2:r+h*(o-2*r),stroke:"#E5E7EB",strokeDasharray:"4 4"},h)),s.map((h,b)=>{const m=r+b*((i-2*r)/s.length)+4,c=Number(h[l]||0)/p*(o-2*r);return e.jsxs("g",{children:[e.jsx("rect",{x:m,y:o-r-c,width:v,height:c,fill:t,rx:"6",children:e.jsxs("title",{children:[h[a],": ",h[l]]})}),e.jsx("text",{x:m+v/2,y:o-10,textAnchor:"middle",fontSize:"9",fill:"#6B7280",children:String(h[a]).slice(0,12)}),e.jsx("text",{x:m+v/2,y:o-r-c-6,textAnchor:"middle",fontSize:"10",fontWeight:"700",fill:"#10243E",children:h[l]})]},b)})]})}function ca({data:s,height:a=280}){if(!s||s.length===0)return e.jsx("div",{className:"chart-empty",children:"Sin datos suficientes."});const l=700,n=a,t=36,i=["Dom","Lun","Mar","Mié","Jue","Vie","Sáb"],o=(l-t*1.5)/24,r=(n-t*1.5)/7,d=Math.max(1,...s.map(v=>v.total||0));function p(v){const h=v/d,b=Math.round(16+185*h),m=Math.round(36+126*h),c=Math.round(62+-23*h);return`rgb(${b},${m},${c})`}return e.jsxs("svg",{viewBox:`0 0 ${l} ${n}`,className:"chart-svg",children:[i.map((v,h)=>e.jsx("text",{x:t-8,y:t+(h+.6)*r,textAnchor:"end",fontSize:"10",fill:"#6B7280",children:v},v)),Array.from({length:24}).map((v,h)=>h%3===0?e.jsxs("text",{x:t+(h+.5)*o,y:n-12,textAnchor:"middle",fontSize:"9",fill:"#6B7280",children:[h,"h"]},h):null),Array.from({length:7}).flatMap((v,h)=>Array.from({length:24}).map((b,m)=>{const c=s.find(_=>_.day_of_week===h&&_.hour_of_day===m),x=(c==null?void 0:c.total)||0;return e.jsx("rect",{x:t+m*o,y:t+h*r,width:o-1.5,height:r-1.5,fill:x?p(x):"#F4F7FB",rx:"3",children:e.jsxs("title",{children:[i[h]," ",m,"h: ",x]})},`${h}-${m}`)}))]})}function da({segments:s,label:a}){if(!s||s.length===0)return e.jsx("div",{className:"chart-empty",children:"Sin datos."});const l=s.reduce((p,v)=>p+v.value,0)||1,n=100,t=100,i=80,o=50;let r=0;function d(p,v){const h=n+i*Math.cos(p-Math.PI/2),b=t+i*Math.sin(p-Math.PI/2),m=n+i*Math.cos(v-Math.PI/2),c=t+i*Math.sin(v-Math.PI/2),x=n+o*Math.cos(v-Math.PI/2),_=t+o*Math.sin(v-Math.PI/2),y=n+o*Math.cos(p-Math.PI/2),w=t+o*Math.sin(p-Math.PI/2),g=v-p>Math.PI?1:0;return`M ${h} ${b} A ${i} ${i} 0 ${g} 1 ${m} ${c} L ${x} ${_} A ${o} ${o} 0 ${g} 0 ${y} ${w} Z`}return e.jsxs("svg",{viewBox:"0 0 200 200",className:"chart-svg",style:{maxWidth:220},children:[s.map((p,v)=>{const h=r/l*Math.PI*2;r+=p.value;const b=r/l*Math.PI*2;return e.jsx("path",{d:d(h,b),fill:p.color,children:e.jsxs("title",{children:[p.label,": ",p.value," (",Math.round(p.value/l*100),"%)"]})},v)}),e.jsx("text",{x:n,y:t-4,textAnchor:"middle",fontSize:"22",fontWeight:"800",fill:"#10243E",children:l}),e.jsx("text",{x:n,y:t+14,textAnchor:"middle",fontSize:"10",fill:"#6B7280",children:a})]})}function ma({steps:s}){if(!s||s.length===0)return e.jsx("div",{className:"chart-empty",children:"Sin datos."});const a=700,l=60*s.length+20,n=Math.max(1,...s.map(t=>t.value));return e.jsx("svg",{viewBox:`0 0 ${a} ${l}`,className:"chart-svg",children:s.map((t,i)=>{const o=t.value/n*(a-100),r=(a-o)/2,d=i*60+10,p=n?Math.round(t.value/n*100):0;return e.jsxs("g",{children:[e.jsx("rect",{x:r,y:d,width:o,height:48,rx:"8",fill:`rgba(16,36,62,${.85-i*.15})`}),e.jsx("text",{x:a/2,y:d+22,textAnchor:"middle",fontSize:"13",fontWeight:"700",fill:"#fff",children:t.label}),e.jsxs("text",{x:a/2,y:d+40,textAnchor:"middle",fontSize:"11",fill:"rgba(255,255,255,0.85)",children:[t.value," (",p,"%)"]})]},i)})})}function ua(){var n,t,i,o;const[s,a]=u.useState({loading:!0});if(u.useEffect(()=>{(async()=>{try{const[r,d,p,v,h,b]=await Promise.all([N.from("view_sessions_timeline").select("*").limit(60),N.from("view_hourly_distribution").select("*"),N.from("view_question_variance").select("*"),N.from("view_completion_funnel").select("*").single(),N.from("assessment_sessions").select("general_level"),N.from("view_pumai_metrics").select("*").single()]),m={bajo:0,moderado:0,prioritario:0};for(const x of h.data||[])m[x.general_level]!==void 0&&m[x.general_level]++;const c=(r.data||[]).slice().reverse();a({loading:!1,timeline:c,heatmap:d.data||[],variance:p.data||[],funnel:v.data||{started:0,completed:0,abandoned:0},levels:m,pumai:b.data||{}})}catch(r){console.warn(r),a({loading:!1,error:r.message})}})()},[]),s.loading)return e.jsx("div",{className:"spinner",style:{margin:"40px auto"}});const l=(n=s.pumai)!=null&&n.total_calls?Math.round(s.pumai.gemini_count/s.pumai.total_calls*100):null;return e.jsxs(e.Fragment,{children:[e.jsx("header",{className:"page-head",children:e.jsxs("div",{children:[e.jsx("span",{className:"tag",children:"Analítica"}),e.jsx("h1",{className:"mt-2",children:"Estadísticas y tendencias"}),e.jsx("p",{className:"lede",children:"Métricas agregadas para entender el comportamiento de la comunidad y la salud del sistema."})]})}),e.jsxs("div",{className:"stats-grid",children:[e.jsxs("section",{className:"panel",children:[e.jsx("h2",{children:"Tendencia de sesiones (últimos días)"}),e.jsx(Me,{data:s.timeline,x:"day",y:"total",label:"Sesiones por día"})]}),e.jsxs("section",{className:"panel",children:[e.jsx("h2",{children:"Distribución por nivel"}),e.jsx(da,{label:"sesiones",segments:[{label:"Bajo",value:s.levels.bajo,color:"#8FB8A0"},{label:"Moderado",value:s.levels.moderado,color:"#C9A227"},{label:"Prioritario",value:s.levels.prioritario,color:"#D26B53"}]})]})]}),e.jsxs("section",{className:"panel mt-3",children:[e.jsx("h2",{children:"Embudo de completación"}),e.jsx(ma,{steps:[{label:"Sesiones iniciadas",value:s.funnel.started||0},{label:"Tests completados",value:s.funnel.completed||0}]}),s.funnel.abandoned>0&&e.jsxs("p",{className:"note",children:[s.funnel.abandoned," sesiones quedaron sin completar."]})]}),e.jsxs("section",{className:"panel mt-3",children:[e.jsx("h2",{children:"Heatmap de horarios"}),e.jsx("p",{className:"note",children:"Cuándo se hacen los tests (día de la semana × hora)."}),e.jsx(ca,{data:s.heatmap})]}),e.jsxs("section",{className:"panel mt-3",children:[e.jsx("h2",{children:"Preguntas con mayor varianza"}),e.jsx("p",{className:"note",children:"Reactivos que diferencian más a la población — los más informativos del instrumento."}),e.jsx(Re,{data:(s.variance||[]).slice(0,8).map(r=>({label:`#${r.sort_order}`,value:Number(r.stddev||0),tip:r.question_text})),x:"label",y:"value",color:"#C9A227"}),e.jsxs("details",{className:"mt-2",children:[e.jsx("summary",{children:"Ver detalles"}),e.jsx("ul",{style:{paddingLeft:20,fontSize:"0.9rem"},children:(s.variance||[]).slice(0,10).map(r=>e.jsxs("li",{children:[e.jsxs("strong",{children:["#",r.sort_order]})," (",r.dimension,", σ=",Number(r.stddev||0).toFixed(2),"): ",r.question_text]},r.question_id))})]})]}),e.jsxs("section",{className:"panel mt-3",children:[e.jsx("h2",{children:"Métricas de Pum-AI"}),e.jsxs("div",{className:"kpi-grid",children:[e.jsx(Z,{label:"Llamadas totales",value:((t=s.pumai)==null?void 0:t.total_calls)??0}),e.jsx(Z,{label:"Pum-AI exitosa",value:((i=s.pumai)==null?void 0:i.gemini_count)??0,accent:"sage"}),e.jsx(Z,{label:"Fallback local",value:((o=s.pumai)==null?void 0:o.fallback_count)??0,accent:"coral"}),e.jsx(Z,{label:"Tasa de éxito",value:l!=null?l+"%":"—",accent:"gold"})]})]}),e.jsx("style",{children:`
        .stats-grid {
          display: grid;
...
`),m=new Blob([b],{type:"text/csv;charset=utf-8"}),c=document.createElement("a");c.href=URL.createObjectURL(m),c.download=`audit-${new Date().toISOString().slice(0,10)}.csv`,c.click()}return e.jsxs("section",{className:"panel",children:[e.jsxs("div",{style:{display:"flex",gap:8,flexWrap:"wrap",marginBottom:12},children:[e.jsx("input",{className:"input",placeholder:"Buscar admin, ID, contenido…",value:l,onChange:h=>n(h.target.value),style:{maxWidth:300}}),e.jsxs("select",{value:t,onChange:h=>i(h.target.value),children:[e.jsx("option",{value:"all",children:"Todas las entidades"}),e.jsx("option",{value:"questions",children:"Preguntas"}),e.jsx("option",{value:"recommendations",children:"Recomendaciones"}),e.jsx("option",{value:"resources",children:"Recursos"}),e.jsx("option",{value:"admin_users",children:"Usuarios admin"}),e.jsx("option",{value:"prompt",children:"Prompt Pum-AI"}),e.jsx("option",{value:"alerts",children:"Alertas"})]}),e.jsx("button",{className:"btn btn-ghost btn-sm",onClick:v,children:"⬇ Exportar CSV"})]}),o?e.jsx("div",{className:"spinner",style:{margin:"24px auto"}}):e.jsx("div",{className:"table-wrap",style:{maxHeight:600,overflowY:"auto"},children:e.jsxs("table",{className:"admin-table",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Cuándo"}),e.jsx("th",{children:"Quién"}),e.jsx("th",{children:"Acción"}),e.jsx("th",{children:"Entidad"}),e.jsx("th",{children:"ID"})]})}),e.jsx("tbody",{children:p.length===0?e.jsx("tr",{children:e.jsx("td",{colSpan:5,className:"note text-center",children:"Sin registros."})}):p.map(h=>{var b;return e.jsxs("tr",{children:[e.jsx("td",{children:new Date(h.created_at).toLocaleString("es-MX")}),e.jsx("td",{children:h.admin_email||"—"}),e.jsx("td",{children:h.action}),e.jsx("td",{children:h.entity}),e.jsx("td",{children:e.jsx("code",{children:((b=h.entity_id)==null?void 0:b.slice(0,8))||"—"})})]},h.id)})})]})})]})}function Ca(){const[s,a]=u.useState([]),[l,n]=u.useState(!0);async function t(){n(!0);const{data:r}=await N.from("view_suspicious_ips").select("*");a(r||[]),n(!1)}u.useEffect(()=>{t()},[]);async function i(r){confirm("¿Bloquear esta IP? No podrá registrar nuevas cuentas anónimas ni usar el chat.")&&(await N.from("ip_blocklist").upsert({ip_hash:r,reason:"manual block by admin"}),t())}async function o(r){confirm("¿Limpiar el historial de esta IP? Resetea el contador de rate limit (útil para testing).")&&(await N.from("ip_log").delete().eq("ip_hash",r),t())}return e.jsxs("section",{className:"panel",children:[e.jsx("p",{className:"note",children:"IPs (hasheadas) que crearon más de 5 códigos anónimos en las últimas 24h."}),l?e.jsx("div",{className:"spinner",style:{margin:"24px auto"}}):s.length===0?e.jsx("p",{className:"note text-center",children:"Sin IPs sospechosas en este momento. 🟢"}):e.jsx("div",{className:"table-wrap mt-2",children:e.jsxs("table",{className:"admin-table",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Prefix"}),e.jsx("th",{children:"Hash"}),e.jsx("th",{children:"Eventos"}),e.jsx("th",{children:"Códigos distintos"}),e.jsx("th",{children:"Endpoints"}),e.jsx("th",{children:"Última actividad"}),e.jsx("th",{})]})}),e.jsx("tbody",{children:s.map(r=>e.jsxs("tr",{children:[e.jsx("td",{children:r.ip_prefix||"—"}),e.jsx("td",{children:e.jsxs("code",{style:{fontSize:"0.74rem"},children:[r.ip_hash.slice(0,12),"…"]})}),e.jsx("td",{children:r.total_events}),e.jsx("td",{children:e.jsx("strong",{children:r.distinct_codes})}),e.jsx("td",{children:e.jsx("small",{children:(r.endpoints||[]).join(", ")})}),e.jsx("td",{children:new Date(r.last_at).toLocaleString("es-MX")}),e.jsxs("td",{style:{whiteSpace:"nowrap"},children:[e.jsx("button",{className:"icon-btn",onClick:()=>o(r.ip_hash),title:"Borra logs y resetea rate limit",children:"🧹 Limpiar"})," ",e.jsx("button",{className:"icon-btn danger",onClick:()=>i(r.ip_hash),children:"🚫 Bloquear"})]})]},r.ip_hash))})]})}),e.jsx("style",{children:`
        ...
        .icon-btn.danger { color: #93362A; border-color: var(--c-coral-500); }
      `})]})}function Aa(){const[s,a]=u.useState([]),[l,n]=u.useState(!0),[t,i]=u.useState(!1),[o,r]=u.useState(null);async function d(){n(!0);const{data:h}=await N.from("ip_blocklist").select("*").order("blocked_at",{ascending:!1});a(h||[]),n(!1)}u.useEffect(()=>{d()},[]);async function p(h){confirm("¿Desbloquear esta IP? También limpiará su historial de logs (para evitar re-bloqueo automático).")&&(await N.from("ip_blocklist").delete().eq("ip_hash",h),await N.from("ip_log").delete().eq("ip_hash",h),d())}async function v(){var h,b;if(confirm(`⚠️ MODO TESTING

¿Borrar TODOS los logs de IP de las últimas 24h y desbloquear TODAS las IPs?

Esto resetea los rate limits de toda la plataforma. Útil cuando estás probando con tu propia conexión y quieres seguir registrando códigos.`)){i(!0),r(null);try{const m=new Date(Date.now()-864e5).toISOString(),[c,x]=await Promise.all([N.from("ip_log").delete().gte("created_at",m),N.from("ip_blocklist").delete().gte("blocked_at",m)]);if(c.error||x.error)throw new Error(((h=c.error)==null?void 0:h.message)||((b=x.error)==null?void 0:b.message));r("✅ Logs de IP y blocklist de las últimas 24h limpiados. Ya puedes volver a registrar."),d()}catch(m){r("❌ "+(m.message||"Error al resetear"))}finally{i(!1)}}}return e.jsxs("section",{className:"panel",children:[e.jsx("p",{className:"note",children:"IPs bloqueadas para nuevas operaciones públicas (registro/chat). Auto-bloqueo después de más de 5 registros en 24h."}),l?e.jsx("div",{className:"spinner",style:{margin:"24px auto"}}):s.length===0?e.jsx("p",{className:"note text-center",children:"Ninguna IP bloqueada. 🟢"}):e.jsx("div",{className:"table-wrap mt-2",children:e.jsxs("table",{className:"admin-table",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Hash"}),e.jsx("th",{children:"Razón"}),e.jsx("th",{children:"Bloqueada"}),e.jsx("th",{})]})}),e.jsx("tbody",{children:s.map(h=>e.jsxs("tr",{children:[e.jsx("td",{children:e.jsxs("code",{style:{fontSize:"0.74rem"},children:[h.ip_hash.slice(0,16),"…"]})}),e.jsx("td",{children:e.jsx("small",{children:h.reason})}),e.jsx("td",{children:new Date(h.blocked_at).toLocaleString("es-MX")}),e.jsx("td",{children:e.jsx("button",{className:"icon-btn",onClick:()=>p(h.ip_hash),children:"✓ Desbloquear y limpiar logs"})})]},h.ip_hash))})]})}),e.jsxs("div",{className:"testing-box mt-4",children:[e.jsx("h3",{children:"🧪 Modo testing — resetear rate limits"}),e.jsxs("p",{className:"note",children:["Cuando estás probando registros con tu propia IP y te auto-bloqueas, este botón limpia todos los logs y desbloqueos de las últimas 24h. ",e.jsx("strong",{children:"No usar en producción real."})]}),e.jsx("button",{className:"btn btn-ghost",onClick:v,disabled:t,children:t?"Reseteando…":"🧹 Resetear rate limits de las últimas 24h"}),o&&e.jsx("p",{className:"note mt-2",children:e.jsx("strong",{children:o})})]}),e.jsx("style",{children:`
        .icon-btn { background:transparent; border: 1px solid var(--c-borde); padding: 6px 10px; border-radius: 8px; cursor: pointer; font-size: 0.85rem; }
        .testing-box {
          margin-top: 20px;
          padding: 16px 18px;
      ...
      `})]})}const za={estado_emocional:"Estado emocional",estres_academico:"Estrés académico",sueno_descanso:"Sueño y descanso",apoyo_social:"Apoyo social",motivacion_pertenencia:"Motivación"};function Ea(){const[s,a]=u.useState([]),[l,n]=u.useState([]),[t,i]=u.useState([]),[o,r]=u.useState(!0);if(u.useEffect(()=>{(async()=>{const[h,b,m]=await Promise.all([N.from("view_cohorts_monthly").select("*").limit(12),N.from("view_dimension_heatmap").select("*").limit(80),N.from("view_feedback_summary").select("*").limit(30)]);a(h.data||[]),n(b.data||[]),i(m.data||[]),r(!1)})()},[]),o)return e.jsx("div",{className:"spinner",style:{margin:"80px auto"}});const d=[...new Set(l.map(h=>h.week))].sort().slice(-12),v=[...new Set(l.map(h=>h.dimension_id))].map(h=>({dimension:h,cells:d.map(b=>{const m=l.find(c=>c.week===b&&c.dimension_id===h);return{week:b,score:(m==null?void 0:m.avg_score)??null,samples:(m==null?void 0:m.samples)??0}})}));return e.jsxs(e.Fragment,{children:[e.jsx("header",{className:"page-head",children:e.jsxs("div",{children:[e.jsx("span",{className:"tag azul",children:"Análisis avanzado"}),e.jsx("h1",{className:"mt-2",children:"Cohortes, tendencias y benchmarks"}),e.jsx("p",{className:"lede",children:"Comparativas mensuales, heatmap dimensión × tiempo, y feedback agregado."})]})}),e.jsxs("section",{className:"panel",children:[e.jsx("h2",{children:"Cohortes mensuales"}),e.jsx("p",{className:"note",children:"Cómo se compara cada mes con los anteriores en participación y nivel general."}),e.jsx(Re,{data:s.slice(0,6).reverse().map(h=>({label:h.cohort,value:h.total})),x:"label",y:"value",color:"#1A3358"}),e.jsx("div",{className:"table-wrap mt-2",children:e.jsxs("table",{className:"admin-table",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Mes"}),e.jsx("th",{children:"Total"}),e.jsx("th",{children:"Promedio"}),e.jsx("th",{children:"Bajo"}),e.jsx("th",{children:"Moderado"}),e.jsx("th",{children:"Prioritario"})]})}),e.jsx("tbody",{children:s.map(h=>e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("strong",{children:h.cohort})}),e.jsx("td",{children:h.total}),e.jsx("td",{children:h.avg_score}),e.jsx("td",{children:e.jsx("span",{className:"lvl-bg-bajo",style:{padding:"2px 8px",borderRadius:6},children:h.bajo})}),e.jsx("td",{children:e.jsx("span",{className:"lvl-bg-moderado",style:{padding:"2px 8px",borderRadius:6},children:h.moderado})}),e.jsx("td",{children:e.jsx("span",{className:"lvl-bg-prioritario",style:{padding:"2px 8px",borderRadius:6},children:h.prioritario})})]},h.cohort))})]})})]}),e.jsxs("section",{className:"panel mt-3",children:[e.jsx("h2",{children:"Heatmap: dimensiones × semanas"}),e.jsx("p",{className:"note",children:"Color = puntaje promedio (más oscuro = mayor atención requerida)."}),e.jsx("div",{className:"hm-wrap",style:{overflowX:"auto"},children:e.jsxs("table",{className:"hm-table",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Dimensión"}),d.map(h=>e.jsx("th",{className:"hm-col",children:new Date(h).toLocaleDateString("es-MX",{day:"2-digit",month:"short"})},h))]})}),e.jsx("tbody",{children:v.map(h=>e.jsxs("tr",{children:[e.jsx("td",{className:"hm-row-label",children:za[h.dimension]||h.dimension}),h.cells.map((b,m)=>e.jsx("td",{className:"hm-cell",style:{background:b.score===null?"#F4F7FB":Ma(b.score),color:b.score&&b.score>50?"#fff":"var(--c-azul-800)"},title:`${b.score??"—"} (n=${b.samples})`,children:b.score??"—"},m))]},h.dimension))})]})}),e.jsx("style",{children:`
        ...
        `})]}),t.length>0&&e.jsxs("section",{className:"panel mt-3",children:[e.jsx("h2",{children:"Tendencia de feedback"}),e.jsx("p",{className:"note",children:"Calificaciones diarias (1-5)."}),e.jsx(Me,{data:t.slice(0,14).reverse().map(h=>({day:h.day,total:h.avg_rating,raw:h})),x:"day",y:"total",label:"Promedio diario de feedback"})]})]})}function Ma(s){const a=Math.max(0,Math.min(1,s/100)),l=Math.round(143+67*a),n=Math.round(184+-77*a),t=Math.round(160+-77*a);return`rgb(${l},${n},${t})`}const Ra=[{id:"trees",label:"🌳 Árboles"},{id:"events",label:"📅 Eventos"},{id:"webinars",label:"📡 Webinars"},{id:"hunts",label:"🗺 Treasure Hunts"},{id:"library",label:"📚 Biblioteca"},{id:"specialists",label:"🩺 Especialistas"},{id:"blocks",label:"📄 Bloques de página"}];function Ia({ctx:s}){const[a,l]=u.useState("trees");return e.jsxs(e.Fragment,{children:[e.jsx("header",{className:"page-head",children:e.jsxs("div",{children:[e.jsx("span",{className:"tag sage",children:"Programa"}),e.jsx("h1",{className:"mt-2",children:"Gestión del programa"}),e.jsx("p",{className:"lede",children:"Administra el contenido vivo del proyecto: árboles, eventos, aventuras, biblioteca y especialistas."})]})}),e.jsx("div",{className:"tabs",children:Ra.map(n=>e.jsx("button",{className:`tab-btn ${a===n.id?"active":""}`,onClick:()=>l(n.id),children:n.label},n.id))}),e.jsxs("div",{className:"mt-3",children:[a==="trees"&&e.jsx(qa,{ctx:s}),a==="events"&&e.jsx(La,{ctx:s}),a==="webinars"&&e.jsx(Pa,{ctx:s}),a==="hunts"&&e.jsx(Ta,{ctx:s}),a==="library"&&e.jsx(Fa,{ctx:s}),a==="specialists"&&e.jsx($a,{ctx:s}),a==="blocks"&&e.jsx(Ba,{ctx:s})]}),e.jsx("style",{children:`
      ...
      `})]})}function Da({ctx:s,hunt:a,onClose:l}){var b;const[n,t]=u.useState(a||{title:"",description:"",reward_label:"",reward_image:"",starts_at:"",ends_at:"",active:!0,clues:[]}),[i,o]=u.useState(!1);function r(){t(m=>{var c;return{...m,clues:[...m.clues||[],{clue_order:(((c=m.clues)==null?void 0:c.length)||0)+1,riddle:"",hint:"",unlock_after:"always"}]}})}function d(m,c,x){t(_=>({..._,clues:_.clues.map((y,w)=>w===m?{...y,[c]:x}:y)}))}function p(m){t(c=>({...c,clues:c.clues.filter((x,_)=>_!==m)}))}async function v(){o(!0);try{let m=a==null?void 0:a.id;const c={title:n.title,description:n.description,reward_label:n.reward_label,reward_image:n.reward_image,starts_at:n.starts_at,ends_at:n.ends_at,active:n.active};if(m){const{error:x}=await N.from("game_events").update(c).eq("id",m);if(x)throw x;await z({ctx:s,action:"update",entity:"game_events",entity_id:m,after_data:c})}else{const{data:x,error:_}=await N.from("game_events").insert(c).select().single();if(_)throw _;m=x.id,await z({ctx:s,action:"create",entity:"game_events",entity_id:m,after_data:x})}await N.from("game_clues").delete().eq("event_id",m);for(const x of n.clues)await N.from("game_clues").insert({event_id:m,clue_order:x.clue_order,riddle:x.riddle,hint:x.hint,unlock_after:x.unlock_after,reveal_at_lat:x.reveal_at_lat||null,reveal_at_lng:x.reveal_at_lng||null});l()}catch(m){alert(m.message)}finally{o(!1)}}async function h(){a!=null&&a.id&&confirm(`¿Eliminar la aventura "${a.title}"?`)&&(await N.from("game_events").delete().eq("id",a.id),await z({ctx:s,action:"delete",entity:"game_events",entity_id:a.id,before_data:a}),l())}return e.jsxs("div",{className:"overlay",onClick:l,children:[e.jsxs("div",{className:"modal",onClick:m=>m.stopPropagation(),children:[e.jsxs("header",{children:[e.jsx("h3",{children:a?"✏️ Editar aventura":"✨ Nueva aventura"}),e.jsx("button",{onClick:l,children:"✕"})]}),e.jsxs("div",{className:"grid-form",children:[e.jsxs("div",{className:"field",style:{gridColumn:"1/-1"},children:[e.jsx("label",{children:"Título"}),e.jsx("input",{value:n.title,onChange:m=>t({...n,title:m.target.value})})]}),e.jsxs("div",{className:"field",style:{gridColumn:"1/-1"},children:[e.jsx("label",{children:"Descripción"}),e.jsx("textarea",{value:n.description||"",onChange:m=>t({...n,description:m.target.value})})]}),e.jsxs("div",{className:"field",children:[e.jsx("label",{children:"Inicio"}),e.jsx("input",{type:"datetime-local",value:U(n.starts_at),onChange:m=>t({...n,starts_at:m.target.value})})]}),e.jsxs("div",{className:"field",children:[e.jsx("label",{children:"Fin"}),e.jsx("input",{type:"datetime-local",value:U(n.ends_at),onChange:m=>t({...n,ends_at:m.target.value})})]}),e.jsxs("div",{className:"field",style:{gridColumn:"1/-1"},children:[e.jsx("label",{children:"Recompensa"}),e.jsx("input",{value:n.reward_label||"",onChange:m=>t({...n,reward_label:m.target.value})})]}),e.jsxs("div",{className:"field",children:[e.jsx("label",{children:"Activo"}),e.jsxs("select",{value:n.active?"1":"0",onChange:m=>t({...n,active:m.target.value==="1"}),children:[e.jsx("option",{value:"1",children:"Sí"}),e.jsx("option",{value:"0",children:"No"})]})]})]}),e.jsx("h4",{className:"mt-3",children:"Pistas"}),((b=n.clues)==null?void 0:b.length)===0&&e.jsx("p",{className:"note",children:"Aún sin pistas. Agrega al menos 1."}),(n.clues||[]).map((m,c)=>e.jsxs("div",{className:"clue-edit",children:[e.jsxs("header",{children:[e.jsxs("strong",{children:["Pista #",m.clue_order]}),e.jsx("button",{onClick:()=>p(c),className:"icon-btn",children:"🗑"})]}),e.jsxs("div",{className:"grid-form",children:[e.jsxs("div",{className:"field",children:[e.jsx("label",{children:"Orden"}),e.jsx("input",{type:"number",value:m.clue_order,onChange:x=>d(c,"clue_order",Number(x.target.value))})]}),e.jsxs("div",{className:"field",children:[e.jsx("label",{children:"Desbloquea con"}),e.jsxs("select",{value:m.unlock_after||"always",onChange:x=>d(c,"unlock_after",x.target.value),children:[e.jsx("option",{value:"always",children:"Disponible al inicio"}),e.jsx("option",{value:"checkin_count:1",children:"1 check-in"}),e.jsx("option",{value:"checkin_count:2",children:"2 check-ins"}),e.jsx("option",{value:"checkin_count:3",children:"3 check-ins"}),e.jsx("option",{value:"wellness_route_done",children:"Completar ruta de bienestar"})]})]}),e.jsxs("div",{className:"field",style:{gridColumn:"1/-1"},children:[e.jsx("label",{children:"Adivinanza / pista"}),e.jsx("textarea",{value:m.riddle||"",onChange:x=>d(c,"riddle",x.target.value)})]}),e.jsxs("div",{className:"field",style:{gridColumn:"1/-1"},children:[e.jsx("label",{children:"Hint adicional (opcional)"}),e.jsx("input",{value:m.hint||"",onChange:x=>d(c,"hint",x.target.value)})]}),e.jsxs("div",{className:"field",children:[e.jsx("label",{children:"Lat (opcional)"}),e.jsx("input",{type:"number",step:"0.0001",value:m.reveal_at_lat||"",onChange:x=>d(c,"reveal_at_lat",x.target.value)})]}),e.jsxs("div",{className:"field",children:[e.jsx("label",{children:"Lng (opcional)"}),e.jsx("input",{type:"number",step:"0.0001",value:m.reveal_at_lng||"",onChange:x=>d(c,"reveal_at_lng",x.target.value)})]})]})]},c)),e.jsx("button",{className:"btn btn-ghost btn-sm mt-2",onClick:r,children:"＋ Agregar pista"}),e.jsxs("div",{style:{display:"flex",gap:8,marginTop:18},children:[e.jsx("button",{className:"btn btn-primary",onClick:v,disabled:i,children:i?"Guardando…":"✓ Guardar aventura"}),e.jsx("button",{className:"btn btn-ghost",onClick:l,children:"Cancelar"}),a&&e.jsx("button",{className:"btn btn-coral",onClick:h,style:{marginLeft:"auto"},children:"🗑 Eliminar"})]})]}),e.jsx("style",{children:`
      ...
      `})]})}function Ba({ctx:s}){const[a,l]=u.useState([]),[n,t]=u.useState(null),[i,o]=u.useState({}),[r,d]=u.useState("all"),[p,v]=u.useState(!0);async function h(){v(!0);const{data:j}=await N.from("content_blocks").select("*").order("page").order("order_idx");l(j||[]),v(!1)}u.useEffect(()=>{h()},[]);function b(){t("new"),o({page:"support",section_key:"",title:"",body:"",list_items:[],emoji:"",order_idx:(a.length||0)+1,active:!0})}function m(j){t(j.id),o({...j,list_items:Array.isArray(j.list_items)?j.list_items:[]})}async function c(){var f;const j={...i,updated_at:new Date().toISOString(),updated_by:s.admin.id,list_items:(f=i.list_items)!=null&&f.length?i.list_items:null};if(n==="new"){const{data:k,error:C}=await N.from("content_blocks").insert(j).select().single();if(C)return alert(C.message);await z({ctx:s,action:"create",entity:"content_blocks",entity_id:k.id,after_data:k})}else{const k=a.find(E=>E.id===n),{error:C}=await N.from("content_blocks").update(j).eq("id",n);if(C)return alert(C.message);await z({ctx:s,action:"update",entity:"content_blocks",entity_id:n,before_data:k,after_data:j})}t(null),o({}),h()}async function x(j){confirm(`¿Eliminar bloque "${j.title}"?`)&&(await N.from("content_blocks").delete().eq("id",j.id),await z({ctx:s,action:"delete",entity:"content_blocks",entity_id:j.id,before_data:j}),h())}function _(){o(j=>({...j,list_items:[...j.list_items||[],""]}))}function y(j,f){o(k=>({...k,list_items:k.list_items.map((C,E)=>E===j?f:C)}))}function w(j){o(f=>({...f,list_items:f.list_items.filter((k,C)=>C!==j)}))}const g=r==="all"?a:a.filter(j=>j.page===r);return p?e.jsx("div",{className:"spinner",style:{margin:"24px auto"}}):e.jsxs("section",{className:"panel",children:[e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",gap:8,flexWrap:"wrap"},children:[e.jsxs("h2",{children:["Bloques de contenido (",a.length,")"]}),e.jsxs("div",{style:{display:"flex",gap:8},children:[e.jsxs("select",{value:r,onChange:j=>d(j.target.value),children:[e.jsx("option",{value:"all",children:"Todas las páginas"}),e.jsx("option",{value:"support",children:"Apoyo (/apoyo)"}),e.jsx("option",{value:"teachers",children:"Docentes (/admin/docentes)"}),e.jsx("option",{value:"home",children:"Inicio"})]}),e.jsx("button",{className:"btn btn-primary btn-sm",onClick:b,children:"＋ Nuevo bloque"})]})]}),e.jsxs("p",{className:"note mt-2",children:["Los bloques aparecen en las páginas públicas correspondientes ordenados por ",e.jsx("code",{children:"order_idx"}),". Soporta ",e.jsx("code",{children:"**negritas**"})," en items de lista."]}),(n==="new"||n)&&e.jsxs("div",{className:"edit-area mt-3",children:[e.jsxs("div",{className:"grid-form",children:[e.jsxs("div",{className:"field",children:[e.jsx("label",{children:"Página"}),e.jsxs("select",{value:i.page,onChange:j=>o({...i,page:j.target.value}),children:[e.jsx("option",{value:"support",children:"Apoyo (/apoyo)"}),e.jsx("option",{value:"teachers",children:"Docentes (/admin/docentes)"}),e.jsx("option",{value:"home",children:"Inicio"})]})]}),e.jsxs("div",{className:"field",children:[e.jsx("label",{children:"Section key (slug)"}),e.jsx("input",{value:i.section_key||"",onChange:j=>o({...i,section_key:j.target.value.replace(/\s+/g,"_").toLowerCase()}),placeholder:"ej. alertas"})]}),e.jsxs("div",{className:"field",children:[e.jsx("label",{children:"Emoji"}),e.jsx("input",{value:i.emoji||"",onChange:j=>o({...i,emoji:j.target.value}),placeholder:"🎯"})]}),e.jsxs("div",{className:"field",children:[e.jsx("label",{children:"Orden"}),e.jsx("input",{type:"number",value:i.order_idx||0,onChange:j=>o({...i,order_idx:Number(j.target.value)})})]}),e.jsxs("div",{className:"field",style:{gridColumn:"1/-1"},children:[e.jsx("label",{children:"Título"}),e.jsx("input",{value:i.title||"",onChange:j=>o({...i,title:j.target.value})})]}),e.jsxs("div",{className:"field",style:{gridColumn:"1/-1"},children:[e.jsx("label",{children:"Texto introductorio (opcional)"}),e.jsx("textarea",{rows:2,value:i.body||"",onChange:j=>o({...i,body:j.target.value})})]})]}),e.jsxs("div",{className:"field",style:{marginTop:12},children:[e.jsx("label",{children:"Items de lista (bullets)"}),(i.list_items||[]).map((j,f)=>e.jsxs("div",{style:{display:"flex",gap:6,marginBottom:6},children:[e.jsx("input",{value:j,onChange:k=>y(f,k.target.value),placeholder:`Item ${f+1}`}),e.jsx("button",{className:"btn btn-ghost btn-sm",onClick:()=>w(f),type:"button",children:"✕"})]},f)),e.jsx("button",{className:"btn btn-ghost btn-sm",onClick:_,type:"button",children:"＋ Agregar item"})]}),e.jsx("div",{className:"field",style:{marginTop:12},children:e.jsxs("label",{children:[e.jsx("input",{type:"checkbox",checked:!!i.active,onChange:j=>o({...i,active:j.target.checked})})," Activo"]})}),e.jsxs("div",{style:{display:"flex",gap:8,marginTop:10},children:[e.jsx("button",{className:"btn btn-primary btn-sm",onClick:c,children:"✓ Guardar"}),e.jsx("button",{className:"btn btn-ghost btn-sm",onClick:()=>{t(null),o({})},children:"Cancelar"})]})]}),e.jsx("div",{className:"table-wrap mt-3",children:e.jsxs("table",{className:"admin-table",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Página"}),e.jsx("th",{children:"Section"}),e.jsx("th",{children:"Título"}),e.jsx("th",{children:"Items"}),e.jsx("th",{children:"Orden"}),e.jsx("th",{children:"Activo"}),e.jsx("th",{})]})}),e.jsx("tbody",{children:g.map(j=>e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("code",{children:j.page})}),e.jsx("td",{children:e.jsx("code",{children:j.section_key})}),e.jsxs("td",{children:[j.emoji," ",j.title]}),e.jsx("td",{children:Array.isArray(j.list_items)?j.list_items.length:0}),e.jsx("td",{children:j.order_idx}),e.jsx("td",{children:j.active?"✅":"⏸"}),e.jsxs("td",{className:"actions-cell",children:[e.jsx("button",{className:"icon-btn",onClick:()=>m(j),children:"✎"}),e.jsx("button",{className:"icon-btn danger",onClick:()=>x(j),children:"🗑"})]})]},j.id))})]})}),e.jsx("style",{children:`
        ...
        .grid-form { display: grid; grid-template-columns: 1fr 1fr; gap: 10px; }
        @media (max-width: 720px) { .grid-form { grid-template-columns: 1fr; } }
      `})]})}function ee({ctx:s,table:a,entity:l,title:n,columns:t,defaultRow:i,Form:o}){const[r,d]=u.useState([]),[p,v]=u.useState(null),[h,b]=u.useState({}),[m,c]=u.useState(!0);async function x(){c(!0);const{data:f}=await N.from(a).select("*");d(f||[]),c(!1)}u.useEffect(()=>{x()},[a]);function _(){v("new"),b({...i})}function y(f){v(f.id),b({...f})}async function w(){const f=j(h);if(p==="new"){const{data:k,error:C}=await N.from(a).insert(f).select().single();if(C)return alert(C.message);await z({ctx:s,action:"create",entity:l,entity_id:k.id,after_data:k})}else{const k=r.find(E=>E.id===p),{error:C}=await N.from(a).update(f).eq("id",p);if(C)return alert(C.message);await z({ctx:s,action:"update",entity:l,entity_id:p,before_data:k,after_data:f})}v(null),b({}),x()}async function g(f){confirm("¿Eliminar este registro?")&&(await N.from(a).delete().eq("id",f.id),await z({ctx:s,action:"delete",entity:l,entity_id:f.id,before_data:f}),x())}function j(f){const k={...f};for(const C in k)k[C]===""&&(C.endsWith("_at")||C.endsWith("_lat")||C.endsWith("_lng")||C==="capacity"||C==="duration_sec")&&(k[C]=null);return k}return m?e.jsx("div",{className:"spinner",style:{margin:"24px auto"}}):e.jsxs("section",{className:"panel",children:[e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:8},children:[e.jsxs("h2",{children:[n," (",r.length,")"]}),e.jsx("button",{className:"btn btn-primary btn-sm",onClick:_,children:"＋ Nuevo"})]}),(p==="new"||p)&&e.jsxs("div",{className:"edit-area mt-3",children:[e.jsx(o,{draft:h,setDraft:b}),e.jsxs("div",{style:{display:"flex",gap:8,marginTop:10},children:[e.jsx("button",{className:"btn btn-primary btn-sm",onClick:w,children:"✓ Guardar"}),e.jsx("button",{className:"btn btn-ghost btn-sm",onClick:()=>{v(null),b({})},children:"Cancelar"})]})]}),e.jsx("div",{className:"table-wrap mt-3",children:e.jsxs("table",{className:"admin-table",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[t.map(f=>e.jsx("th",{children:f.label},f.key)),e.jsx("th",{})]})}),e.jsx("tbody",{children:r.length===0?e.jsx("tr",{children:e.jsx("td",{colSpan:t.length+1,className:"note text-center",children:"Sin registros aún."})}):r.map(f=>e.jsxs("tr",{children:[t.map(k=>e.jsx("td",{children:k.format?k.format(f[k.key]):f[k.key]??"—"},k.key)),e.jsxs("td",{className:"actions-cell",children:[e.jsx("button",{className:"icon-btn",onClick:()=>y(f),children:"✎"}),e.jsx("button",{className:"icon-btn danger",onClick:()=>g(f),children:"🗑"})]})]},f.id))})]})}),e.jsx("style",{children:`
        .edit-area { background: var(--c-azul-100); padding: 14px; border-radius: 12px; }
        .actions-cell { display: flex; gap: 4px; }
        .icon-btn { background: transparent; border: 1px solid var(--c-borde); padding: 4px 8px; border-radius: 6px; cursor: pointer; }
        .icon-btn.danger { color: #93362A; border-color: var(--c-coral-500); }
      `})]})}const H=24*3600*1e3,_e=["#10243E","#C9A227","#8FB8A0","#D26B53","#B7A8D9","#1A3358","#4FA88E"];function Oa({ctx:s}){var B;const a=((B=s==null?void 0:s.admin)==null?void 0:B.role)==="admin",[l,n]=u.useState([]),[t,i]=u.useState(null),[o,r]=u.useState([]),[d,p]=u.useState(!0),[v,h]=u.useState(""),[b,m]=u.useState("all"),[c,x]=u.useState({key:"engagement_score",dir:"desc"}),[_,y]=u.useState(null),[w,g]=u.useState(!1);async function j(){p(!0);const[S,M,A]=await Promise.all([N.from("view_student_activity").select("*"),N.from("view_anonymous_kpis").select("*").maybeSingle(),N.from("view_faculty_distribution").select("*")]);n(S.data||[]),i(M.data||{}),r(A.data||[]),p(!1)}u.useEffect(()=>{j()},[]);const f=u.useMemo(()=>{const S=Date.now()-30*H;return l.filter(M=>!M.last_activity_at||new Date(M.last_activity_at).getTime()<S).length},[l]),k=u.useMemo(()=>{let S=l;if(v){const A=v.toLowerCase();S=S.filter(q=>q.anonymous_code.toLowerCase().includes(A)||(q.faculty||"").toLowerCase().includes(A)||(q.career||"").toLowerCase().includes(A))}const M=Date.now();return b==="active7"&&(S=S.filter(A=>A.last_activity_at&&new Date(A.last_activity_at).getTime()>M-7*H)),b==="active30"&&(S=S.filter(A=>A.last_activity_at&&new Date(A.last_activity_at).getTime()>M-30*H)),b==="inactive30"&&(S=S.filter(A=>!A.last_activity_at||new Date(A.last_activity_at).getTime()<M-30*H)),b==="flagged"&&(S=S.filter(A=>A.chat_flagged_count>0)),S=[...S].sort((A,q)=>{const F=A[c.key],P=q[c.key];if(F===P)return 0;if(F==null)return 1;if(P==null)return-1;const ce=typeof F=="number"?F-P:String(F).localeCompare(String(P));return c.dir==="asc"?ce:-ce}),S},[l,v,b,c]);function C(S){x(M=>M.key===S?{key:S,dir:M.dir==="asc"?"desc":"asc"}:{key:S,dir:"desc"})}function E(){const S=["anonymous_code","faculty","career","registered_at","last_activity_at","sessions_count","checkins_count","journal_count","achievements_count","routes_completed","trees_adopted","events_rsvped","chat_messages_count","engagement_score"],M=S.join(",")+`
`+k.map(F=>S.map(P=>`"${String(F[P]??"").replace(/"/g,'""')}"`).join(",")).join(`
`),A=new Blob([M],{type:"text/csv;charset=utf-8"}),q=document.createElement("a");q.href=URL.createObjectURL(A),q.download=`usuarios-anonimos-${new Date().toISOString().slice(0,10)}.csv`,q.click()}async function L(S){if(!a)return alert("Solo el rol Administrador puede borrar usuarios.");if(confirm(`⚠ ELIMINAR ${S}
...
`)),y(null),j()}catch(A){alert("Error: "+A.message)}finally{g(!1)}}}return d?e.jsx("div",{className:"spinner",style:{margin:"80px auto"}}):e.jsxs(e.Fragment,{children:[e.jsxs("header",{className:"page-head",children:[e.jsxs("div",{children:[e.jsx("span",{className:"tag azul",children:"Comunidad anónima"}),e.jsx("h1",{className:"mt-2",children:"Usuarios anónimos"}),e.jsx("p",{className:"lede",children:"Quiénes están usando AURA. Sin nombres ni identificadores personales — solo códigos y métricas."})]}),e.jsx("button",{className:"btn btn-ghost btn-sm",onClick:E,children:"⬇ Exportar CSV"})]}),e.jsxs("div",{className:"hero-stats",children:[e.jsx(D,{icon:"👥",label:"Total registrados",value:(t==null?void 0:t.total_registered)??0,accent:"azul"}),e.jsx(D,{icon:"🌿",label:"Activos esta semana",value:(t==null?void 0:t.active_7d)??0,sub:`${Ne(t==null?void 0:t.active_7d,t==null?void 0:t.total_registered)}% del total`,accent:"sage"}),e.jsx(D,{icon:"📅",label:"Activos último mes",value:(t==null?void 0:t.active_30d)??0,sub:`${Ne(t==null?void 0:t.active_30d,t==null?void 0:t.total_registered)}% del total`,accent:"gold"}),e.jsx(D,{icon:"⏰",label:"Inactivos +1 mes",value:f,sub:"Sin actividad reciente",accent:"coral",actionLabel:f>0?"Filtrar →":null,onAction:()=>m("inactive30")}),e.jsx(D,{icon:"🔐",label:"Con contraseña",value:(t==null?void 0:t.with_password)??0,sub:"Pueden volver con su clave"}),e.jsx(D,{icon:"📝",label:"Check-ins totales",value:(t==null?void 0:t.total_checkins)??0}),e.jsx(D,{icon:"📔",label:"Diario",value:(t==null?void 0:t.total_journal_entries)??0,sub:"Entradas escritas"}),e.jsx(D,{icon:"🌳",label:"Árboles adoptados",value:(t==null?void 0:t.total_tree_adoptions)??0,accent:"sage"})]}),o.length>0&&e.jsxs("section",{className:"panel mt-3",children:[e.jsx("h2",{children:"Distribución por facultad"}),e.jsx("div",{className:"faculty-grid",children:o.slice(0,8).map((S,M)=>e.jsx(Ua,{f:S,color:_e[M%_e.length],total:(t==null?void 0:t.total_registered)||1},S.faculty))})]}),e.jsxs("section",{className:"panel mt-3",children:[e.jsxs("div",{className:"filter-row",children:[e.jsx("input",{className:"search",placeholder:"🔍 Buscar código, facultad, carrera…",value:v,onChange:S=>h(S.target.value)}),e.jsx("div",{className:"chips",children:[{id:"all",label:`Todos (${l.length})`},{id:"active7",label:"Activos 7d"},{id:"active30",label:"Activos 30d"},{id:"inactive30",label:`💤 Inactivos +1mes (${f})`,accent:"coral"},{id:"flagged",label:"⚠ Flaggeados"}].map(S=>e.jsx("button",{className:`chip ${b===S.id?"active":""} ${S.accent||""}`,onClick:()=>m(S.id),children:S.label},S.id))}),e.jsxs("small",{className:"note",children:["Mostrando ",e.jsx("strong",{children:k.length})," de ",l.length]})]}),e.jsx("div",{className:"table-wrap mt-3",style:{maxHeight:600,overflowY:"auto"},children:e.jsxs("table",{className:"admin-table",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:e.jsx(T,{k:"anonymous_code",sortBy:c,onSort:C,children:"Código"})}),e.jsx("th",{children:e.jsx(T,{k:"faculty",sortBy:c,onSort:C,children:"Facultad"})}),e.jsx("th",{children:e.jsx(T,{k:"sessions_count",sortBy:c,onSort:C,children:"Tests"})}),e.jsx("th",{children:e.jsx(T,{k:"checkins_count",sortBy:c,onSort:C,children:"Check-ins"})}),e.jsx("th",{children:e.jsx(T,{k:"journal_count",sortBy:c,onSort:C,children:"Diario"})}),e.jsx("th",{children:e.jsx(T,{k:"routes_completed",sortBy:c,onSort:C,children:"Rutas ✓"})}),e.jsx("th",{children:e.jsx(T,{k:"chat_messages_count",sortBy:c,onSort:C,children:"💬"})}),e.jsx("th",{children:e.jsx(T,{k:"engagement_score",sortBy:c,onSort:C,children:"Score"})}),e.jsx("th",{children:e.jsx(T,{k:"last_activity_at",sortBy:c,onSort:C,children:"Última actividad"})}),e.jsx("th",{})]})}),e.jsxs("tbody",{children:[k.length===0&&e.jsx("tr",{children:e.jsx("td",{colSpan:10,className:"note text-center",children:"Sin usuarios con esos filtros."})}),k.map(S=>{const M=!S.last_activity_at||Date.now()-new Date(S.last_activity_at).getTime()>30*H;return e.jsxs("tr",{className:M?"row-inactive":"",children:[e.jsxs("td",{children:[e.jsx("code",{style:{cursor:"pointer"},onClick:()=>y(S),children:S.anonymous_code}),M&&e.jsx("span",{title:"Inactivo +1mes",style:{marginLeft:6,fontSize:"0.8rem"},children:"💤"})]}),e.jsx("td",{children:e.jsx("small",{children:S.faculty||"—"})}),e.jsx("td",{children:S.sessions_count}),e.jsx("td",{children:S.checkins_count}),e.jsx("td",{children:S.journal_count}),e.jsx("td",{children:S.routes_completed}),e.jsxs("td",{children:[S.chat_messages_count,S.chat_flagged_count>0&&e.jsx("span",{title:"Flaggeado",style:{color:"#93362A",marginLeft:4},children:"⚠"})]}),e.jsx("td",{children:e.jsx("strong",{style:{color:S.engagement_score>50?"var(--c-salvia-600)":S.engagement_score>10?"var(--c-azul-800)":"var(--c-gris)"},children:S.engagement_score})}),e.jsx("td",{children:e.jsx("small",{children:S.last_activity_at?new Date(S.last_activity_at).toLocaleString("es-MX",{month:"short",day:"2-digit",hour:"2-digit",minute:"2-digit"}):"—"})}),e.jsxs("td",{className:"row-actions",children:[e.jsx("button",{className:"icon-btn",onClick:()=>y(S),title:"Ver detalle",children:"👁"}),a&&e.jsx("button",{className:"icon-btn danger",onClick:()=>L(S.anonymous_code),disabled:w,title:"Eliminar usuario",children:"🗑"})]})]},S.anonymous_code)})]})]})})]}),_&&e.jsx(Wa,{user:_,isFullAdmin:a,onClose:()=>y(null),onDelete:()=>L(_.anonymous_code),busy:w}),e.jsx("style",{children:`
      ...
      `})]})}function Ya(s){return s?String(s).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\*\*(.+?)\*\*/g,"<strong>$1</strong>").replace(/`(.+?)`/g,"<code>$1</code>"):""}function I({ctx:s,permission:a,role:l,children:n}){var i;const t=(i=s==null?void 0:s.admin)==null?void 0:i.role;return t?l&&t!==l?e.jsx(Ce,{role:t}):a&&!Y(t,a)?e.jsx(Ce,{role:t}):n:e.jsx(Ae,{to:"/admin/login",replace:!0})}function Ce({role:s}){return e.jsx("section",{className:"section",children:e.jsx("div",{className:"container text-center",style:{maxWidth:520},children:e.jsxs("div",{className:"panel",children:[e.jsx("h1",{children:"🔒 Acceso restringido"}),e.jsxs("p",{className:"lede",children:["Tu rol ",e.jsx("strong",{children:s})," no tiene permiso para ver esta sección."]}),e.jsx("p",{className:"note",children:"Si crees que esto es un error, contacta a la coordinación del programa."}),e.jsx("a",{href:"/aura-fesi/admin",className:"btn btn-primary",children:"← Volver al panel"})]})})})}function is(){const s=Te(),[a,l]=u.useState(null),[n,t]=u.useState(!0);if(u.useEffect(()=>{(async()=>{const o=await de().catch(()=>null);if(!o){s("/admin/login",{replace:!0});return}l(o),t(!1)})()},[s]),n)return e.jsx("section",{className:"section",children:e.jsxs("div",{className:"container text-center",children:[e.jsx("div",{className:"spinner",style:{margin:"40px auto 18px"}}),e.jsx("p",{className:"lede",children:"Verificando sesión…"})]})});if(!a)return null;async function i(){const o=await de().catch(()=>null);o&&l(o)}return e.jsxs("div",{className:"admin-shell",children:[e.jsx(Ye,{ctx:a}),e.jsx("main",{className:"admin-main",children:e.jsxs(De,{children:[e.jsx(R,{index:!0,element:a.admin.role==="docente"?e.jsx(Se,{}):e.jsx(Ja,{ctx:a})}),e.jsx(R,{path:"perfil",element:e.jsx(Je,{ctx:a,onUpdated:i})}),e.jsx(R,{path:"estadisticas",element:e.jsx(I,{ctx:a,permission:"view_aggregated",children:e.jsx(ua,{})})}),e.jsx(R,{path:"avanzado",element:e.jsx(I,{ctx:a,permission:"view_aggregated",children:e.jsx(Ea,{})})}),e.jsx(R,{path:"insights",element:e.jsx(I,{ctx:a,permission:"view_insights",children:e.jsx(ya,{})})}),e.jsx(R,{path:"sesiones",element:e.jsx(I,{ctx:a,permission:"view_detail",children:e.jsx(Qa,{})})}),e.jsx(R,{path:"buscar",element:e.jsx(I,{ctx:a,permission:"view_detail",children:e.jsx(ga,{ctx:a})})}),e.jsx(R,{path:"anonimos",element:e.jsx(I,{ctx:a,permission:"view_detail",children:e.jsx(Oa,{ctx:a})})}),e.jsx(R,{path:"contenido",element:e.jsx(I,{ctx:a,permission:"manage_content",children:e.jsx(ta,{ctx:a})})}),e.jsx(R,{path:"programa",element:e.jsx(I,{ctx:a,permission:"manage_content",children:e.jsx(Ia,{ctx:a})})}),e.jsx(R,{path:"exportar",element:e.jsx(I,{ctx:a,permission:"view_aggregated",children:e.jsx(xa,{ctx:a})})}),e.jsx(R,{path:"sistema",element:e.jsx(I,{ctx:a,permission:"manage_config",children:e.jsx(va,{ctx:a})})}),e.jsx(R,{path:"operacion",element:e.jsx(I,{ctx:a,permission:"manage_security",children:e.jsx(ka,{ctx:a})})}),e.jsx(R,{path:"seguridad",element:e.jsx(I,{ctx:a,permission:"manage_security",children:e.jsx(Xa,{})})}),e.jsx(R,{path:"costos-ai",element:e.jsx(I,{ctx:a,permission:"manage_security",children:e.jsx(Va,{})})}),e.jsx(R,{path:"usuarios",element:e.jsx(I,{ctx:a,permission:"manage_users",children:e.jsx(Za,{ctx:a})})}),e.jsx(R,{path:"auditoria",element:e.jsx(I,{ctx:a,permission:"manage_users",children:e.jsx(oa,{})})}),e.jsx(R,{path:"docentes",element:e.jsx(I,{ctx:a,permission:"view_teachers_kit",children:e.jsx(Se,{})})}),e.jsx(R,{path:"*",element:e.jsx(Ae,{to:"",replace:!0})})]})}),e.jsx("style",{children:`
        .admin-shell {
          display: grid;
      ...
      `})]})}function Ja({ctx:s}){var o,r,d,p,v,h;const a=s.admin.role,[l,n]=u.useState({}),[t,i]=u.useState({loading:!0});return u.useEffect(()=>{(async()=>{const[b,m]=await Promise.all([qe(),Le()]);n({supabase:b,gemini:m})})()},[]),u.useEffect(()=>{if(!Pe){i({loading:!1});return}if(!Y(a,"view_aggregated")){i({loading:!1});return}(async()=>{try{const[{count:b},m,c]=await Promise.all([N.from("assessment_sessions").select("*",{count:"exact",head:!0}),N.from("view_dimension_impact").select("*"),N.from("assessment_sessions").select("id, anonymous_code, total_score, general_level, top_attention_areas, created_at").order("created_at",{ascending:!1}).limit(10)]),x=c.data||[],_=x.length?Math.round(x.reduce((g,j)=>g+(j.total_score||0),0)/x.length):null,y={bajo:0,moderado:0,prioritario:0},w=await N.from("assessment_sessions").select("general_level").not("general_level","is",null);for(const g of w.data||[])y[g.general_level]!==void 0&&y[g.general_level]++;i({loading:!1,total:b??0,avg:_,recent:x,dimensions:m.data||[],levels:y})}catch(b){console.warn(b),i({loading:!1,error:b.message})}})()},[a]),e.jsxs(e.Fragment,{children:[e.jsxs("header",{className:"page-head dashboard-head",children:[e.jsxs("div",{className:"dashboard-welcome",children:[e.jsx("img",{src:"/aura-fesi/Aura.png",alt:"AURA",className:"dashboard-logo",loading:"eager",decoding:"async"}),e.jsxs("div",{children:[e.jsx("span",{className:"tag",children:"Panel administrativo"}),e.jsx("h1",{className:"mt-2",children:"Bienvenida, bienvenido"}),e.jsxs("p",{className:"lede",children:["Como ",e.jsx("strong",{children:ze[a]}),", accedes a ",Ka(a),"."]})]})]}),e.jsxs("div",{className:"health",children:[e.jsx(ne,{label:"Backend",ok:(o=l.supabase)==null?void 0:o.ok}),e.jsx(ne,{label:"BD",ok:(r=l.supabase)==null?void 0:r.ok}),e.jsx(ne,{label:"Pum-AI",ok:(d=l.gemini)==null?void 0:d.ok})]}),e.jsx("style",{children:`
          .dashboard-welcome {
            display: flex;
            align-items: center;
            gap: 22px;
